...
const s = StyleSheet.create({
  ...
  taskTitle: { fontSize: Type.title3.fontSize, fontWeight: '700' as const, color: Colors.text, marginBottom: Tokens.spacing.sm },
  searchBar: {
    flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.fillTertiary,
    borderRadius: Tokens.radius.card, paddingHorizontal: Tokens.spacing.sm, gap: Tokens.spacing.xs, height: 42, marginBottom: Tokens.spacing.xs,
  },
  searchInput: { flex: 1, fontSize: Type.bodyCompact.fontSize, color: Colors.text },
  catScroll: { maxHeight: 40, marginBottom: Tokens.spacing.xs },
  catContent: { gap: 6, paddingRight: Tokens.spacing.md },
  catChip: {
    paddingHorizontal: Tokens.spacing.sm, paddingVertical: 7, borderRadius: 20, backgroundColor: Colors.fillTertiary,
  },
  ...
  rateCardTop: { flexDirection: 'row', alignItems: 'center', padding: Tokens.spacing.sm, gap: 10 },
  rateInfo: { flex: 1, gap: Tokens.spacing.hairline },
  ...
  expandToggle: {
    ...
    paddingHorizontal: Tokens.spacing.sm, paddingBottom: Tokens.spacing.xs, gap: 6,
  },
  expandText: { fontSize: Type.caption2.fontSize, color: Colors.info, fontWeight: '500' as const },
  expandedContent: {
    padding: Tokens.spacing.sm, paddingTop: Tokens.spacing.xs, borderTopWidth: 0.5, borderTopColor: Colors.borderLight,
    backgroundColor: Colors.surfaceAlt, gap: Tokens.spacing.xxs,
  },
  ...
  crewCard: {
    backgroundColor: Colors.surface, borderRadius: Tokens.radius.card, padding: 14, gap: 10, marginBottom: Tokens.spacing.md,
    borderWidth: 1, borderColor: Colors.cardBorder,
  },
  crewRow: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xs },
  ...
  qtyInput: {
    ...
    fontWeight: '700' as const, color: Colors.text, borderWidth: 1, borderColor: Colors.border, marginBottom: Tokens.spacing.md,
  },
  resultCard: {
    backgroundColor: Colors.surface, borderRadius: Tokens.radius.panel, padding: Tokens.spacing.md, gap: 10,
    borderWidth: 1, borderColor: Colors.primary + '30',
  },
  resultTitle: { fontSize: Type.callout.fontSize, fontWeight: '700' as const, color: Colors.text },
  costRow: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: Tokens.spacing.xs,
  },
  ...
  scheduleCard: {
    backgroundColor: Colors.infoLight, borderRadius: Tokens.radius.md, padding: Tokens.spacing.sm, gap: Tokens.spacing.xs,
  },
  ...
  addBtn: {
    ...
    backgroundColor: Colors.primary, borderRadius: Tokens.radius.lg, paddingVertical: 14, marginTop: Tokens.spacing.xxs,
  },
