...
const s = StyleSheet.create({
  ...
  saveBtn: {
    ...
    backgroundColor: Colors.primary, borderRadius: Tokens.radius.lg, paddingVertical: 14, marginBottom: Tokens.spacing.md,
  },
  saveBtnText: { fontSize: Type.subhead.fontSize, fontWeight: '700' as const, color: Colors.textOnPrimary },
  emptyState: { alignItems: 'center', paddingVertical: Tokens.spacing['3xl'], gap: 10 },
  ...
  sectionTitle: {
    fontSize: Type.subhead.fontSize, fontWeight: '700' as const, color: Colors.text, marginBottom: Tokens.spacing.xs, marginTop: Tokens.spacing.xxs,
  },
  versionCard: {
    backgroundColor: Colors.surface, borderRadius: Tokens.radius.card, padding: 14, marginBottom: Tokens.spacing.xs,
    borderWidth: 1.5, borderColor: Colors.cardBorder, gap: Tokens.spacing.xs,
  },
  ...
  versionMeta: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xxs },
  versionDate: { fontSize: Type.caption2.fontSize, color: Colors.textMuted },
  versionRight: { alignItems: 'flex-end', gap: Tokens.spacing.hairline },
  ...
  deleteBtn: {
    flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xxs, alignSelf: 'flex-end' as const,
    paddingHorizontal: Tokens.spacing.xs, paddingVertical: Tokens.spacing.xxs, borderRadius: Tokens.radius.xs, backgroundColor: Colors.errorLight,
  },
  deleteBtnText: { fontSize: Type.caption2.fontSize, fontWeight: '600' as const, color: Colors.error },
  comparisonSection: { marginTop: Tokens.spacing.xs, gap: Tokens.spacing.xs },
  compTable: {
  ...
  compRow: {
    flexDirection: 'row', paddingHorizontal: Tokens.spacing.sm, paddingVertical: 10,
  ...
  compDivider: { height: 1, backgroundColor: Colors.border, marginHorizontal: Tokens.spacing.sm },
  changesSection: { marginTop: Tokens.spacing.sm, gap: 6 },
  changesSectionTitle: { fontSize: Type.footnote.fontSize, fontWeight: '700' as const, color: Colors.text, marginBottom: Tokens.spacing.hairline },
  changeRow: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between',
    borderRadius: Tokens.radius.md, padding: 10, gap: Tokens.spacing.xs,
  },
  changeInfo: { flex: 1, gap: Tokens.spacing.xxs },
  ...
  changeAmounts: { alignItems: 'flex-end', gap: Tokens.spacing.hairline },
