...
const s = StyleSheet.create({
  ...
  headerSub: { fontSize: Type.footnote.fontSize, color: Colors.textSecondary, marginTop: Tokens.spacing.hairline },
  closeBtn: {
    width: 34, height: 34, borderRadius: 17, backgroundColor: Colors.fillTertiary,
    alignItems: 'center', justifyContent: 'center',
  },
  body: { flex: 1, paddingHorizontal: Tokens.spacing.md, paddingTop: Tokens.spacing.sm },
  stepTitle: { fontSize: Type.subheadline.fontSize, fontWeight: '700' as const, color: Colors.text, marginBottom: Tokens.spacing.xxs },
  stepSubtitle: { fontSize: Type.footnote.fontSize, color: Colors.textSecondary, marginBottom: Tokens.spacing.sm },
  categoryRow: { flexDirection: 'row', gap: 6, marginBottom: Tokens.spacing.sm, flexWrap: 'wrap' },
  catChip: {
    paddingHorizontal: Tokens.spacing.sm, paddingVertical: 7, borderRadius: 20,
  ...
  modelList: { flex: 1 },
  modelCard: {
    backgroundColor: Colors.surface, borderRadius: Tokens.radius.lg, padding: 14, marginBottom: Tokens.spacing.xs,
    borderWidth: 1, borderColor: Colors.cardBorder, gap: 10,
  },
  modelCardTop: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.sm },
  modelIconWrap: {
    width: 40, height: 40, borderRadius: Tokens.radius.card, alignItems: 'center', justifyContent: 'center',
  },
  modelCardInfo: { flex: 1, gap: Tokens.spacing.hairline },
  ...
  backBtn: { marginBottom: Tokens.spacing.xs },
  backBtnText: { fontSize: Type.footnote.fontSize, color: Colors.primary, fontWeight: '600' as const },
  qualityGrid: { flexDirection: 'row', gap: Tokens.spacing.xs, marginBottom: Tokens.spacing.md, marginTop: Tokens.spacing.xxs },
  qualityCard: {
    flex: 1, backgroundColor: Colors.surface, borderRadius: Tokens.radius.card, padding: Tokens.spacing.sm,
    alignItems: 'center', gap: Tokens.spacing.xxs, borderWidth: 1.5, borderColor: Colors.cardBorder,
  },
  ...
  sqftRow: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.sm, marginBottom: Tokens.spacing.xs },
  sqftBtn: {
  ...
  presetRow: { flexDirection: 'row', gap: 6, marginBottom: Tokens.spacing.md },
  presetChip: {
    paddingHorizontal: Tokens.spacing.sm, paddingVertical: 6, borderRadius: Tokens.radius.panel,
    backgroundColor: Colors.fillTertiary,
  },
  presetText: { fontSize: Type.caption1.fontSize, fontWeight: '500' as const, color: Colors.textSecondary },
  resultCard: {
    backgroundColor: Colors.surface, borderRadius: Tokens.radius.panel, padding: Tokens.spacing.md, gap: Tokens.spacing.sm,
    borderWidth: 1, borderColor: Colors.primary + '30',
  },
  resultHeader: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xs },
  resultTitle: { fontSize: Type.subhead.fontSize, fontWeight: '700' as const, color: Colors.text },
  locationBadge: {
    backgroundColor: Colors.infoLight, borderRadius: Tokens.radius.sm, paddingHorizontal: 10, paddingVertical: Tokens.spacing.xxs,
    alignSelf: 'flex-start',
  },
  locationText: { fontSize: Type.caption2.fontSize, fontWeight: '600' as const, color: Colors.info },
  resultRow: { flexDirection: 'row', gap: Tokens.spacing.xs },
  resultCol: {
    flex: 1, backgroundColor: Colors.background, borderRadius: Tokens.radius.card, padding: Tokens.spacing.sm,
    alignItems: 'center', gap: Tokens.spacing.xxs,
  },
