...
const s = StyleSheet.create({
  ...
  headerDateCol: { width: 80, paddingLeft: Tokens.spacing.xs },
  headerTaskCol: { flex: 1, paddingLeft: Tokens.spacing.xs },
  headerLabel: {
    fontSize: 10,
  ...
  taskBarIcons: { flexDirection: 'row', gap: Tokens.spacing.hairline },
  taskBarTitle: {
    flex: 1,
