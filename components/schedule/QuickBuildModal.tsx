...
const s = StyleSheet.create({
  ...
  handle: { width: 36, height: 4, borderRadius: 2, backgroundColor: Colors.fillTertiary, alignSelf: 'center', marginBottom: Tokens.spacing.xxs },
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  headerLeft: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xs },
  ...
  reviewRow: { flexDirection: 'row', gap: Tokens.spacing.xs },
  ...
  taskPreview: { maxHeight: 200, marginTop: Tokens.spacing.xxs },
  previewRow: {
    flexDirection: 'row',
  ...
  backBtn: { alignSelf: 'center', paddingVertical: Tokens.spacing.xs },
