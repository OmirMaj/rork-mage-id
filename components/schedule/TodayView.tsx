...
const s = StyleSheet.create({
  container: { paddingHorizontal: Tokens.spacing.md, gap: Tokens.spacing.md },
  ...
  todayBadges: { flexDirection: 'row', gap: Tokens.spacing.xs },
  healthMini: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  forecastDay: { alignItems: 'center', gap: Tokens.spacing.hairline, flex: 1 },
  ...
  activeCardContent: { flex: 1, padding: 14, gap: Tokens.spacing.xs },
  activeCardHeader: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
  },
  activeCardTitle: { fontSize: Type.callout.fontSize, fontWeight: '700' as const, color: Colors.text, flex: 1, marginRight: Tokens.spacing.xs },
  dayIndicator: {
    backgroundColor: Colors.fillTertiary,
    paddingHorizontal: Tokens.spacing.xs,
    paddingVertical: 3,
  ...
  quickActions: { flexDirection: 'row', gap: Tokens.spacing.xs },
  quickActionBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: Tokens.spacing.xxs,
  ...
  photoStrip: { flexDirection: 'row', gap: 6, marginTop: Tokens.spacing.hairline },
  photoThumb: {
    width: 40,
    height: 40,
    borderRadius: Tokens.radius.sm,
  ...
  overdueLeft: { flex: 1, gap: Tokens.spacing.hairline },
  ...
  compactInfo: { flex: 1, gap: Tokens.spacing.hairline },
