...
const makeStyles = (t: ThemeColors) => StyleSheet.create({
  ...
  chipOn: { backgroundColor: t.accentFill },
  ...
  generateBtn: { marginTop: 14, backgroundColor: t.accentFill, borderRadius: Tokens.radius.md, paddingVertical: 13, alignItems: 'center' as const },
