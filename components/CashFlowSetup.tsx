...
const styles = StyleSheet.create({
  ...
  handle: { width: 36, height: 5, borderRadius: 3, backgroundColor: Colors.border, alignSelf: 'center', marginBottom: Tokens.spacing.xs },
  header: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: Tokens.spacing.lg, paddingBottom: Tokens.spacing.sm, gap: Tokens.spacing.sm },
  ...
  progressTrack: { height: 4, backgroundColor: Colors.fillTertiary, marginHorizontal: Tokens.spacing.lg, borderRadius: 2, overflow: 'hidden' as const },
  progressFill: { height: 4, backgroundColor: Colors.primary, borderRadius: 2 },
  stepContent: { paddingHorizontal: Tokens.spacing.lg, paddingTop: Tokens.spacing['2xl'], alignItems: 'center' },
  stepIconWrap: { width: 64, height: 64, borderRadius: 32, alignItems: 'center', justifyContent: 'center', marginBottom: Tokens.spacing.lg },
  stepTitle: { fontSize: 24, fontWeight: '800' as const, color: Colors.text, textAlign: 'center', marginBottom: Tokens.spacing.xs },
  stepDesc: { fontSize: Type.subhead.fontSize, color: Colors.textSecondary, textAlign: 'center', lineHeight: 22, marginBottom: Tokens.spacing.xl, paddingHorizontal: Tokens.spacing.md },
  balanceInputWrap: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.surface, borderRadius: Tokens.radius.panel, paddingHorizontal: Tokens.spacing.lg, borderWidth: 2, borderColor: Colors.primary + '30', width: '100%', maxWidth: 280 },
  dollarSign: { fontSize: Type.title1.fontSize, fontWeight: '800' as const, color: Colors.primary, marginRight: Tokens.spacing.xxs },
  balanceInput: { flex: 1, fontSize: 32, fontWeight: '800' as const, color: Colors.text, minHeight: 64, textAlign: 'center' },
  suggestionsRow: { flexDirection: 'row', flexWrap: 'wrap', gap: Tokens.spacing.xs, width: '100%', marginBottom: Tokens.spacing.md },
  suggestionChip: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: Tokens.spacing.sm, paddingVertical: Tokens.spacing.xs, borderRadius: Tokens.radius.md, backgroundColor: Colors.fillTertiary },
  ...
  expenseRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.surface, borderRadius: Tokens.radius.card, padding: Tokens.spacing.sm, marginBottom: Tokens.spacing.xs, borderWidth: 1, borderColor: Colors.cardBorder, gap: 10 },
  expenseInfo: { flex: 1, gap: Tokens.spacing.hairline },
  ...
  expenseAmountWrap: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.surfaceAlt, borderRadius: Tokens.radius.sm, paddingHorizontal: Tokens.spacing.xs },
  ...
  removeBtn: { padding: 6 },
  emptyText: { fontSize: Type.bodyCompact.fontSize, color: Colors.textMuted, textAlign: 'center', paddingVertical: Tokens.spacing.lg },
  termsGrid: { width: '100%', gap: 10 },
  termsChip: { paddingVertical: Tokens.spacing.md, paddingHorizontal: Tokens.spacing.lg, borderRadius: Tokens.radius.lg, backgroundColor: Colors.surface, borderWidth: 1.5, borderColor: Colors.cardBorder, alignItems: 'center' },
  ...
  summaryCard: { width: '100%', backgroundColor: Colors.surface, borderRadius: Tokens.radius.panel, padding: Tokens.spacing.md, borderWidth: 1, borderColor: Colors.cardBorder },
  ...
  footer: { paddingHorizontal: Tokens.spacing.lg, paddingTop: Tokens.spacing.sm, flexDirection: 'row', gap: 10, backgroundColor: Colors.background, borderTopWidth: 0.5, borderTopColor: Colors.borderLight },
