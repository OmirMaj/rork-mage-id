...
const styles = StyleSheet.create({
  ...
  scroll: { paddingHorizontal: Tokens.spacing.lg, paddingTop: Tokens.spacing.xl, paddingBottom: Tokens.spacing['3xl'], alignItems: 'center' },
  heroIconWrap: {
  ...
  featureName: {
    ...
    letterSpacing: -0.4, textAlign: 'center', marginBottom: Tokens.spacing.xxs,
  },
  ...
  priceBox: { alignItems: 'center', marginBottom: Tokens.spacing.lg },
  priceBig: { fontSize: Type.largeTitle.fontSize, fontWeight: '800' as const, color: Colors.text, letterSpacing: -0.8 },
  priceSub: { fontSize: Type.footnote.fontSize, color: Colors.textSecondary, marginTop: Tokens.spacing.hairline },
  savingsRow: { marginTop: 10, backgroundColor: Colors.successLight, borderRadius: Tokens.radius.sm, paddingHorizontal: Tokens.spacing.sm, paddingVertical: 5 },
  ...
  notNowBtn: { paddingVertical: Tokens.spacing.sm },
  ...
  webExplain: { fontSize: Type.bodyCompact.fontSize, color: Colors.textSecondary, textAlign: 'center' as const, lineHeight: 20, marginHorizontal: Tokens.spacing.md, marginBottom: 18 },
});
