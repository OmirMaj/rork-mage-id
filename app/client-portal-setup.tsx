...
const styles = StyleSheet.create({
  ...
  headerSaveBtn: { paddingHorizontal: Tokens.spacing.xxs },
  ...
  linkCardHeader: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xs, marginBottom: 10 },
  linkCardTitle: { fontSize: Type.callout.fontSize, fontWeight: '700', color: Colors.text, flex: 1 },
  activeBadge: { backgroundColor: '#34C75920', borderRadius: Tokens.radius.sm, paddingHorizontal: Tokens.spacing.xs, paddingVertical: Tokens.spacing.hairline },
  activeBadgeText: { fontSize: Type.caption2.fontSize, fontWeight: '600', color: Colors.success },
  linkRow: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: Colors.background, borderRadius: Tokens.radius.sm, padding: 10, marginBottom: Tokens.spacing.sm },
  ...
  section: { paddingHorizontal: Tokens.spacing.md, marginBottom: Tokens.spacing.xl },
  sectionTitle: { fontSize: Type.body.fontSize, fontWeight: '700', color: Colors.text, marginBottom: Tokens.spacing.xxs },
  sectionSubtitle: { fontSize: Type.footnote.fontSize, color: Colors.textMuted, marginBottom: Tokens.spacing.sm, lineHeight: 18 },
  ...
  langGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: Tokens.spacing.xs },
  langChip: {
  ...
  budgetStatusValue: { fontSize: Type.title2.fontSize, fontWeight: '800', color: Colors.text, marginTop: Tokens.spacing.hairline },
  budgetStatusMeta: { fontSize: Type.caption1.fontSize, color: Colors.textMuted, marginTop: Tokens.spacing.hairline },
  ...
  proposalMeta: { fontSize: Type.caption1.fontSize, color: Colors.textMuted, marginTop: Tokens.spacing.hairline },
  ...
  coApprovalMeta: { fontSize: Type.caption2.fontSize, color: Colors.textMuted, marginTop: Tokens.spacing.hairline },
  coApprovalNote: { fontSize: Type.caption1.fontSize, color: Colors.text, marginTop: Tokens.spacing.xxs, fontStyle: 'italic' },
  messagesPreview: {
    marginTop: 10, padding: Tokens.spacing.sm, borderRadius: Tokens.radius.card,
    backgroundColor: Colors.primary + '08',
    borderWidth: 1, borderColor: Colors.primary + '20',
  },
  messagesPreviewHeader: { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: Tokens.spacing.xs },
  ...
  messageAuthor: { fontSize: Type.caption2.fontSize, fontWeight: '700', color: Colors.textMuted, marginBottom: Tokens.spacing.hairline, textTransform: 'uppercase', letterSpacing: 0.4 },
  messageBody: { fontSize: Type.footnote.fontSize, color: Colors.text, lineHeight: 18 },

  inviteForm: { gap: Tokens.spacing.xs },
  input: {
    backgroundColor: Colors.card,
    borderRadius: Tokens.radius.card,
    borderWidth: 1,
  ...
  inviteRow: { flexDirection: 'row', alignItems: 'center', padding: Tokens.spacing.sm, borderBottomWidth: 1, borderBottomColor: Colors.border },
  inviteAvatar: {
  ...
  inviteRight: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xs },
  inviteStatus: {
    flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xxs,
  ...
  emailInviteBtn: { padding: Tokens.spacing.xxs },
  resetPasscodeBtn: {
  ...
  weeklyUpdateTitle: { fontSize: Type.subhead.fontSize, fontWeight: '700', color: Colors.text, marginBottom: Tokens.spacing.hairline },
  weeklyUpdateSub: { fontSize: Type.caption1.fontSize, color: Colors.textMuted, lineHeight: 16 },
  weeklyUpdateArrow: { fontSize: Type.title2.fontSize, color: Colors.textMuted, paddingHorizontal: Tokens.spacing.xxs },
