...
const styles = StyleSheet.create({
  ...
  input: { backgroundColor: Colors.surface, borderRadius: Tokens.radius.md, paddingHorizontal: 14, paddingVertical: Tokens.spacing.sm, fontSize: Type.subhead.fontSize, color: Colors.text, borderWidth: 0.5, borderColor: Colors.borderLight },
  textArea: { minHeight: 100, textAlignVertical: 'top' as const },
  row: { flexDirection: 'row', gap: 10 },
  halfField: { flex: 1 },
  stateScroll: { maxHeight: 36 },
  stateChip: { paddingHorizontal: 10, paddingVertical: 6, borderRadius: Tokens.radius.sm, backgroundColor: Colors.surface, marginRight: Tokens.spacing.xxs, borderWidth: 0.5, borderColor: Colors.borderLight },
  ...
  chip: { paddingHorizontal: Tokens.spacing.sm, paddingVertical: 7, borderRadius: Tokens.radius.sm, backgroundColor: Colors.surface, borderWidth: 0.5, borderColor: Colors.borderLight },
  chipActive: { backgroundColor: Colors.primary, borderColor: Colors.primary },
  chipText: { fontSize: Type.footnote.fontSize, color: Colors.textSecondary, fontWeight: '500' as const },
  chipTextActive: { color: '#FFF' },
  certToggle: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: Colors.surface, borderRadius: Tokens.radius.md, paddingHorizontal: 14, paddingVertical: Tokens.spacing.sm, borderWidth: 0.5, borderColor: Colors.borderLight },
  certToggleText: { fontSize: Type.subhead.fontSize, color: Colors.textSecondary },
  certPickerContainer: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginTop: Tokens.spacing.xs, backgroundColor: Colors.surface, padding: Tokens.spacing.sm, borderRadius: Tokens.radius.md },
  ...
  selectedCerts: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginTop: Tokens.spacing.xs },
  selectedCertBadge: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xxs, backgroundColor: Colors.primary + '15', paddingHorizontal: Tokens.spacing.xs, paddingVertical: Tokens.spacing.xxs, borderRadius: Tokens.radius.xs },
  selectedCertText: { fontSize: Type.caption1.fontSize, color: Colors.primary, fontWeight: '600' as const },
  submitBtn: { backgroundColor: Colors.primary, borderRadius: Tokens.radius.card, paddingVertical: Tokens.spacing.md, alignItems: 'center', marginTop: Tokens.spacing.xl },
