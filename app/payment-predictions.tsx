...
const styles = StyleSheet.create({
  ...
  header: { paddingHorizontal: Tokens.spacing.lg, paddingTop: Tokens.spacing.md, paddingBottom: Tokens.spacing.xs, gap: 6, alignItems: 'center' as const },
  heroIcon: { width: 44, height: 44, borderRadius: Tokens.radius.lg, backgroundColor: Colors.accent + '18', alignItems: 'center' as const, justifyContent: 'center' as const, marginBottom: 6 },
  heroTitle: { fontSize: Type.title2.fontSize, fontWeight: '700' as const, color: Colors.text, letterSpacing: -0.4 },
  heroSub: { fontSize: Type.caption1.fontSize, color: Colors.textSecondary, textAlign: 'center' as const },

  introCard: { margin: Tokens.spacing.md, padding: 18, backgroundColor: Colors.surface, borderRadius: Tokens.radius.panel, borderWidth: 1, borderColor: Colors.border, gap: Tokens.spacing.sm },
  introHeadline: { fontSize: Type.subhead.fontSize, fontWeight: '700' as const, color: Colors.text, letterSpacing: -0.2 },
  introBody: { fontSize: Type.footnote.fontSize, color: Colors.textSecondary, lineHeight: 18 },
  featureRow: { flexDirection: 'row' as const, flexWrap: 'wrap' as const, gap: 6 },
  featureChip: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: Tokens.spacing.xxs, paddingHorizontal: Tokens.spacing.xs, paddingVertical: Tokens.spacing.xxs, borderRadius: Tokens.radius.xs, backgroundColor: Colors.fillSecondary },
  featureText: { fontSize: Type.caption2.fontSize, color: Colors.textSecondary, fontWeight: '600' as const },
  runBtn: { flexDirection: 'row' as const, alignItems: 'center' as const, justifyContent: 'center' as const, gap: 6, paddingVertical: 14, borderRadius: Tokens.radius.card, backgroundColor: Colors.accent, marginTop: Tokens.spacing.xxs },
  runBtnText: { fontSize: Type.subhead.fontSize, fontWeight: '700' as const, color: '#FFF' },

  loadingCard: { margin: Tokens.spacing.md, padding: 28, alignItems: 'center' as const, gap: 10, backgroundColor: Colors.surface, borderRadius: Tokens.radius.panel, borderWidth: 1, borderColor: Colors.border },
  loadingText: { fontSize: Type.bodyCompact.fontSize, fontWeight: '600' as const, color: Colors.text },
  loadingSub: { fontSize: Type.caption1.fontSize, color: Colors.textSecondary, textAlign: 'center' as const },

  errorCard: { margin: Tokens.spacing.md, padding: Tokens.spacing.md, backgroundColor: Colors.error + '10', borderRadius: Tokens.radius.card, borderWidth: 1, borderColor: Colors.error + '30', gap: 10, alignItems: 'center' as const },
  errorText: { fontSize: Type.footnote.fontSize, color: Colors.error, textAlign: 'center' as const },
  retryBtn: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: 6, paddingHorizontal: 14, paddingVertical: Tokens.spacing.xs, borderRadius: Tokens.radius.sm, backgroundColor: Colors.surface, borderWidth: 1, borderColor: Colors.border },
  retryBtnText: { fontSize: Type.footnote.fontSize, fontWeight: '600' as const, color: Colors.primary },

  headlineCard: { margin: Tokens.spacing.md, padding: Tokens.spacing.md, backgroundColor: Colors.surface, borderRadius: Tokens.radius.panel, borderWidth: 1, borderColor: Colors.border, gap: 14 },
  ...
  scoreLabel: { fontSize: 9, color: Colors.textSecondary, fontWeight: '700' as const, textTransform: 'uppercase' as const, letterSpacing: 0.4, marginTop: Tokens.spacing.hairline },
  headlineText: { fontSize: Type.bodyCompact.fontSize, fontWeight: '600' as const, color: Colors.text, lineHeight: 19 },
  topActionWrap: { flexDirection: 'row' as const, alignItems: 'flex-start' as const, gap: 6, marginTop: Tokens.spacing.xs, paddingTop: Tokens.spacing.xs, borderTopWidth: 1, borderTopColor: Colors.border },
  topActionText: { flex: 1, fontSize: Type.caption1.fontSize, color: Colors.textSecondary, lineHeight: 17 },

  metricsRow: { flexDirection: 'row' as const, gap: Tokens.spacing.xs, flexWrap: 'wrap' as const },
  ...
  metricValue: { fontSize: Type.subhead.fontSize, fontWeight: '700' as const, color: Colors.text, letterSpacing: -0.2 },

  listHeading: { fontSize: Type.footnote.fontSize, fontWeight: '700' as const, color: Colors.textSecondary, textTransform: 'uppercase' as const, letterSpacing: 0.5, marginHorizontal: Tokens.spacing.lg, marginTop: Tokens.spacing.xs, marginBottom: Tokens.spacing.xxs },

  invoiceCard: { marginHorizontal: Tokens.spacing.md, marginVertical: 6, padding: 14, backgroundColor: Colors.surface, borderRadius: Tokens.radius.card, borderWidth: 1, borderColor: Colors.border, borderLeftWidth: 4, gap: 10 },
  invoiceHeader: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: Tokens.spacing.xs },
  invoiceTitleRow: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: Tokens.spacing.xs },
  invoiceNumber: { fontSize: Type.bodyCompact.fontSize, fontWeight: '700' as const, color: Colors.text },
  invoiceProject: { fontSize: Type.caption1.fontSize, color: Colors.textSecondary, marginTop: Tokens.spacing.hairline },
  riskPill: { paddingHorizontal: Tokens.spacing.xs, paddingVertical: Tokens.spacing.hairline, borderRadius: Tokens.radius.xs },
  riskPillText: { fontSize: 10, fontWeight: '700' as const, textTransform: 'uppercase' as const, letterSpacing: 0.4 },
  invoiceMetrics: { flexDirection: 'row' as const, gap: Tokens.spacing.xs },
  invoiceMetricBox: { flex: 1, padding: Tokens.spacing.xs, borderRadius: Tokens.radius.sm, backgroundColor: Colors.fillSecondary, gap: Tokens.spacing.hairline },
  ...
  invoiceMetricValue: { fontSize: Type.footnote.fontSize, fontWeight: '700' as const, color: Colors.text },
  ...
  reasonText: { flex: 1, fontSize: Type.caption1.fontSize, color: Colors.textSecondary, lineHeight: 17 },
  actionBlock: { flexDirection: 'row' as const, alignItems: 'flex-start' as const, gap: 6, padding: Tokens.spacing.xs, backgroundColor: Colors.accent + '0D', borderRadius: Tokens.radius.sm },
  actionText: { flex: 1, fontSize: Type.caption1.fontSize, color: Colors.text, fontWeight: '500' as const, lineHeight: 17 },

  rerunBtn: { flexDirection: 'row' as const, alignItems: 'center' as const, justifyContent: 'center' as const, gap: 6, marginHorizontal: Tokens.spacing.md, marginTop: Tokens.spacing.md, paddingVertical: Tokens.spacing.sm, borderRadius: Tokens.radius.md, backgroundColor: Colors.surface, borderWidth: 1, borderColor: Colors.border },
  rerunBtnText: { fontSize: Type.footnote.fontSize, fontWeight: '600' as const, color: Colors.primary },
});
