...
const styles = StyleSheet.create({
  ...
  introCard: { margin: 16, padding: 18, backgroundColor: Colors.surface, borderRadius: Tokens.radius.panel, borderWidth: 1, borderColor: Colors.border, gap: 12 },
  ...
  runBtn: { flexDirection: 'row' as const, alignItems: 'center' as const, justifyContent: 'center' as const, gap: 6, paddingVertical: 14, borderRadius: Tokens.radius.card, backgroundColor: Colors.accent, marginTop: 4 },
  runBtnText: { fontSize: Type.subhead.fontSize, fontWeight: '700' as const, color: '#FFF' },

  loadingCard: { margin: 16, padding: 28, alignItems: 'center' as const, gap: 10, backgroundColor: Colors.surface, borderRadius: Tokens.radius.panel, borderWidth: 1, borderColor: Colors.border },
  ...
  errorCard: { margin: 16, padding: 16, backgroundColor: Colors.error + '10', borderRadius: Tokens.radius.card, borderWidth: 1, borderColor: Colors.error + '30', gap: 10, alignItems: 'center' as const },
  errorText: { fontSize: Type.footnote.fontSize, color: Colors.error, textAlign: 'center' as const },
  retryBtn: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: 6, paddingHorizontal: 14, paddingVertical: 8, borderRadius: Tokens.radius.sm, backgroundColor: Colors.surface, borderWidth: 1, borderColor: Colors.border },
  retryBtnText: { fontSize: Type.footnote.fontSize, fontWeight: '600' as const, color: Colors.primary },

  headlineCard: { margin: 16, padding: 16, backgroundColor: Colors.surface, borderRadius: Tokens.radius.panel, borderWidth: 1, borderColor: Colors.border, gap: 14 },
  ...
  listHeading: { fontSize: Type.footnote.fontSize, fontWeight: '700' as const, color: Colors.textSecondary, textTransform: 'uppercase' as const, letterSpacing: 0.5, marginHorizontal: 20, marginTop: 8, marginBottom: 4 },

  invoiceCard: { marginHorizontal: 16, marginVertical: 6, padding: 14, backgroundColor: Colors.surface, borderRadius: Tokens.radius.card, borderWidth: 1, borderColor: Colors.border, borderLeftWidth: 4, gap: 10 },
  ...
  invoiceProject: { fontSize: Type.caption1.fontSize, color: Colors.textSecondary, marginTop: 2 },
  ...
  actionBlock: { flexDirection: 'row' as const, alignItems: 'flex-start' as const, gap: 6, padding: 8, backgroundColor: Colors.accent + '0D', borderRadius: Tokens.radius.sm },
  actionText: { flex: 1, fontSize: Type.caption1.fontSize, color: Colors.text, fontWeight: '500' as const, lineHeight: 17 },

  rerunBtn: { flexDirection: 'row' as const, alignItems: 'center' as const, justifyContent: 'center' as const, gap: 6, marginHorizontal: 16, marginTop: 16, paddingVertical: 12, borderRadius: Tokens.radius.md, backgroundColor: Colors.surface, borderWidth: 1, borderColor: Colors.border },
