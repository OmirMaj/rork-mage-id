...
const styles = StyleSheet.create({
  pipelineWrap: { paddingHorizontal: Tokens.spacing.md, marginTop: Tokens.spacing.sm, marginBottom: Tokens.spacing.xs },
  ...
  progressSection: { marginHorizontal: Tokens.spacing.lg, marginTop: Tokens.spacing.md, backgroundColor: Colors.card, borderRadius: Tokens.radius.panel, padding: Tokens.spacing.md, borderWidth: 1, borderColor: Colors.cardBorder },
  progressLabel: { fontSize: Type.footnote.fontSize, fontWeight: '600' as const, color: Colors.textSecondary, marginBottom: Tokens.spacing.xs },
  progressRow: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 10 },
  progressInput: { width: 70, minHeight: 44, borderRadius: Tokens.radius.md, backgroundColor: Colors.surfaceAlt, paddingHorizontal: Tokens.spacing.sm, fontSize: Type.subheadline.fontSize, fontWeight: '700' as const, color: Colors.primary, textAlign: 'center' as const },
  ...
  termsRow: { marginHorizontal: Tokens.spacing.lg, marginTop: Tokens.spacing.md, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: Colors.card, borderRadius: Tokens.radius.card, padding: 14, borderWidth: 1, borderColor: Colors.cardBorder },
  fieldLabelInline: { fontSize: Type.bodyCompact.fontSize, fontWeight: '600' as const, color: Colors.text },
  termsSelector: { backgroundColor: Colors.surfaceAlt, paddingHorizontal: Tokens.spacing.sm, paddingVertical: Tokens.spacing.xs, borderRadius: Tokens.radius.sm },
  termsSelectorText: { fontSize: Type.bodyCompact.fontSize, fontWeight: '600' as const, color: Colors.primary },
  termsDropdown: { marginHorizontal: Tokens.spacing.lg, marginTop: Tokens.spacing.xxs, backgroundColor: Colors.card, borderRadius: Tokens.radius.card, borderWidth: 1, borderColor: Colors.cardBorder, overflow: 'hidden' as const },
  termsOption: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: Tokens.spacing.md, paddingVertical: 14, borderBottomWidth: 1, borderBottomColor: Colors.borderLight },
  ...
  fieldLabel: { fontSize: Type.footnote.fontSize, fontWeight: '600' as const, color: Colors.textSecondary, marginBottom: Tokens.spacing.xs, textTransform: 'uppercase' as const, letterSpacing: 0.5 },
  lineItemCard: { backgroundColor: Colors.card, borderRadius: Tokens.radius.md, padding: Tokens.spacing.sm, marginBottom: 6, borderWidth: 1, borderColor: Colors.cardBorder },
  lineItemHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: Tokens.spacing.xxs },
  lineItemName: { fontSize: Type.bodyCompact.fontSize, fontWeight: '600' as const, color: Colors.text, flex: 1, marginRight: Tokens.spacing.xs },
  ...
  textArea: { minHeight: 80, borderRadius: Tokens.radius.lg, backgroundColor: Colors.card, paddingHorizontal: 14, paddingTop: Tokens.spacing.sm, fontSize: Type.subhead.fontSize, color: Colors.text, borderWidth: 1, borderColor: Colors.cardBorder },
  paymentRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: Colors.card, borderRadius: Tokens.radius.md, padding: Tokens.spacing.sm, marginBottom: 6, borderWidth: 1, borderColor: Colors.cardBorder },
  paymentInfo: { gap: Tokens.spacing.hairline },
  ...
  aiaCtaCard: {
    ...
    marginHorizontal: Tokens.spacing.lg, marginTop: Tokens.spacing.xs, marginBottom: Tokens.spacing.lg, padding: 14,
  ...
  aiaCtaTitle: { fontSize: Type.bodyCompact.fontSize, fontWeight: '700' as const, color: Colors.text, marginBottom: Tokens.spacing.hairline },
  aiaCtaSub: { fontSize: Type.caption1.fontSize, color: Colors.textMuted, lineHeight: 16 },
  aiaCtaArrow: { fontSize: 24, color: Colors.primary, marginLeft: Tokens.spacing.xxs },
  ...
  recipientModalInput: { minHeight: 44, borderRadius: Tokens.radius.card, backgroundColor: Colors.surfaceAlt, paddingHorizontal: Tokens.spacing.sm, fontSize: Type.subhead.fontSize, color: Colors.text, borderWidth: 1, borderColor: Colors.cardBorder },
  markPaidBtn: { flex: 1, minHeight: 48, borderRadius: Tokens.radius.lg, backgroundColor: Colors.successLight, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: Tokens.spacing.xs, borderWidth: 1, borderColor: Colors.success + '30' },
  ...
  modalHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: Tokens.spacing.xxs },
  ...
  methodGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: Tokens.spacing.xs, marginTop: Tokens.spacing.xxs },
  methodChip: { paddingHorizontal: Tokens.spacing.md, paddingVertical: 10, borderRadius: Tokens.radius.card, backgroundColor: Colors.fillTertiary },
  ...
  modalSaveBtn: { backgroundColor: Colors.success, borderRadius: Tokens.radius.lg, paddingVertical: 14, alignItems: 'center', flexDirection: 'row', justifyContent: 'center', gap: Tokens.spacing.xs, marginTop: Tokens.spacing.xs },
  ...
  releaseRetentionBtn: { marginHorizontal: Tokens.spacing.md, marginBottom: Tokens.spacing.sm, flexDirection: 'row' as const, alignItems: 'center' as const, gap: Tokens.spacing.xs, paddingVertical: Tokens.spacing.sm, paddingHorizontal: 14, borderRadius: Tokens.radius.card, backgroundColor: Colors.warning + '15', borderWidth: 1, borderColor: Colors.warning + '40' },
  ...
  retentionModalMeta: { fontSize: Type.footnote.fontSize, color: Colors.textSecondary, marginBottom: Tokens.spacing.sm },
  fullReleaseBtn: { paddingHorizontal: 14, paddingVertical: Tokens.spacing.sm, borderRadius: Tokens.radius.md, backgroundColor: Colors.warning + '20', borderWidth: 1, borderColor: Colors.warning + '40' },
  fullReleaseBtnText: { fontSize: Type.footnote.fontSize, fontWeight: '700' as const, color: Colors.warning },
  payLinkCard: {
    marginHorizontal: Tokens.spacing.lg, marginTop: Tokens.spacing.md, padding: Tokens.spacing.md, borderRadius: Tokens.radius.panel,
    backgroundColor: Colors.primary + '08',
    borderWidth: 1, borderColor: Colors.primary + '25',
    gap: Tokens.spacing.sm,
  },
  payLinkHeader: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: Tokens.spacing.sm },
  payLinkIconWrap: {
    width: 36, height: 36, borderRadius: Tokens.radius.md,
    backgroundColor: Colors.primary + '15',
    alignItems: 'center' as const, justifyContent: 'center' as const,
  },
  payLinkTitle: { fontSize: Type.subhead.fontSize, fontWeight: '700' as const, color: Colors.text, marginBottom: Tokens.spacing.hairline },
  ...
  payLinkActions: { flexDirection: 'row' as const, gap: Tokens.spacing.xs },
  payLinkActionBtn: {
