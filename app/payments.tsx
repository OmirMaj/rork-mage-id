...
const styles = StyleSheet.create({
  ...
  payCardInner: { padding: 14, gap: Tokens.spacing.xs },
  payCardHeader: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.sm },
  providerBadge: {
    width: 40,
    height: 40,
    borderRadius: Tokens.radius.md,
  ...
  payCardInfo: { flex: 1, gap: Tokens.spacing.hairline },
  ...
  payCardMetaRow: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xs },
  providerTag: { paddingHorizontal: Tokens.spacing.xs, paddingVertical: 3, borderRadius: Tokens.radius.xs },
