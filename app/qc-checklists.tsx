...
const styles = StyleSheet.create({
  ...
  header: { paddingHorizontal: Tokens.spacing.lg, paddingTop: Tokens.spacing.xs, paddingBottom: 14 },
  ...
  templatePicker: {
    marginHorizontal: Tokens.spacing.md, padding: 14, marginBottom: Tokens.spacing.sm,
  ...
  templateCard: {
    ...
    backgroundColor: Colors.surface, padding: Tokens.spacing.sm, borderRadius: Tokens.radius.md, marginBottom: Tokens.spacing.xs,
    borderWidth: 1, borderColor: Colors.bone,
  },
  templateTitle: { ...Type.bodyEmphasized, color: Colors.ink, marginBottom: Tokens.spacing.hairline },
  templateSub: { ...Type.caption1, color: Colors.concrete },
  cancelTemplateBtn: {
    flexDirection: 'row' as const, alignItems: 'center' as const, justifyContent: 'center' as const, gap: Tokens.spacing.xxs,
    paddingVertical: 10, marginTop: Tokens.spacing.xxs,
  },
  ...
  listTitle: { ...Type.bodyEmphasized, color: Colors.text, marginBottom: Tokens.spacing.hairline },
  listMeta: { ...Type.caption1, color: Colors.textMuted },
  donePill: {
    backgroundColor: Colors.success + '20', paddingHorizontal: 6, paddingVertical: Tokens.spacing.hairline,
    borderRadius: Tokens.radius.xs,
  },
  donePillText: { ...Type.monoSm, color: Colors.success, fontWeight: '700' as const, fontSize: 9 },
  detailHeader: { paddingHorizontal: Tokens.spacing.lg, paddingTop: Tokens.spacing.xs, paddingBottom: Tokens.spacing.md },
  ...
  checkItemText: { ...Type.body, color: Colors.text, marginBottom: Tokens.spacing.xs },
  statusRow: { flexDirection: 'row' as const, gap: 6 },
  statusBtn: { paddingHorizontal: Tokens.spacing.sm, paddingVertical: 6, borderRadius: Tokens.radius.full },
  statusBtnText: { ...Type.caption1, fontWeight: '700' as const, letterSpacing: 0.3 },
  detailFooter: {
    flexDirection: 'row' as const, gap: Tokens.spacing.xs, paddingHorizontal: Tokens.spacing.md, paddingTop: Tokens.spacing.md,
  },
