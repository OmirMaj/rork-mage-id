    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      <View style={styles.header}>
        <View style={styles.headerTop}>
          ...
          <Text style={styles.headerTitle} numberOfLines={1}>Companies</Text>
...
const makeStyles = (t: ThemeColors) => StyleSheet.create({
  ...
  actionBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: t.accentFill, paddingHorizontal: 12, paddingVertical: 7, borderRadius: Tokens.radius.sm },
