  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      <View style={styles.header}>
        ...
        <Text style={[styles.filterSectionLabel, { marginTop: Tokens.spacing.xs }]}>SPECIALTY</Text>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.chipRow}>
          <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  countPill: { backgroundColor: Colors.successLight, paddingHorizontal: 10, paddingVertical: Tokens.spacing.xxs, borderRadius: Tokens.radius.card },
  ...
  card: {
    backgroundColor: Colors.surface, borderRadius: Tokens.radius.lg, marginBottom: Tokens.spacing.sm, overflow: 'hidden' as const,
    // Black outline matches every other card across the app.
    borderWidth: 1, borderColor: Colors.cardBorder,
  },
  companyPhoto: { width: '100%', height: 140 },
  cardTop: { flexDirection: 'row', alignItems: 'center', padding: Tokens.spacing.md, paddingBottom: Tokens.spacing.xs },
  avatarCircle: { width: 44, height: 44, borderRadius: 22, backgroundColor: Colors.primary + '15', alignItems: 'center', justifyContent: 'center', marginRight: Tokens.spacing.sm },
  ...
  specialtyText: { fontSize: Type.caption1.fontSize, color: Colors.accent, fontWeight: '600' as const, marginTop: Tokens.spacing.hairline },
  ratingRow: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xxs, paddingHorizontal: Tokens.spacing.md, marginBottom: Tokens.spacing.xs },
  ...
  addressRow: { flexDirection: 'row', alignItems: 'flex-start', gap: Tokens.spacing.xxs, paddingHorizontal: Tokens.spacing.md, marginBottom: Tokens.spacing.xs },
  addressText: { flex: 1, fontSize: Type.footnote.fontSize, color: Colors.textSecondary, lineHeight: 18 },
  cardFooter: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: Tokens.spacing.md, paddingBottom: 14, paddingTop: Tokens.spacing.xs, borderTopWidth: 0.5, borderTopColor: Colors.borderLight, gap: Tokens.spacing.xs },
  distanceBadge: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xxs, backgroundColor: Colors.infoLight, paddingHorizontal: Tokens.spacing.xs, paddingVertical: Tokens.spacing.xxs, borderRadius: Tokens.radius.xs },
  distanceText: { fontSize: Type.caption1.fontSize, fontWeight: '600' as const, color: Colors.info },
  actionBtn: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xxs, backgroundColor: Colors.primary, paddingHorizontal: Tokens.spacing.sm, paddingVertical: 7, borderRadius: Tokens.radius.sm },
