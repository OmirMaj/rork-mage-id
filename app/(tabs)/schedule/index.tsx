...
const makeStyles = (themeColors: ThemeColors) => StyleSheet.create({
  ...
  fieldBtnActive: { backgroundColor: themeColors.accentFill },
  ...
  ganttOrientBtnActive: { backgroundColor: themeColors.accentFill },
  ...
  baselineToggleActive: { backgroundColor: themeColors.accentFill },
  ...
  doneBtn: { paddingHorizontal: 14, paddingVertical: 6, borderRadius: Tokens.radius.sm, backgroundColor: themeColors.accentFill },
  ...
  phaseChipActive: { backgroundColor: themeColors.accentFill },
  ...
  quickAddToggleActive: { backgroundColor: themeColors.accentFill },
  ...
  addTaskBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, minHeight: 48, borderRadius: Tokens.radius.lg, backgroundColor: themeColors.accentFill },
  ...
  editSaveBtn: { flex: 1, minHeight: 46, borderRadius: Tokens.radius.card, backgroundColor: themeColors.accentFill, alignItems: 'center', justifyContent: 'center' },
  ...
  modalProgressBtnActive: { backgroundColor: themeColors.accentFill, borderColor: themeColors.accent },
  ...
  detailProgressBtnActive: { backgroundColor: themeColors.accentFill },
  ...
  detailEditBtn: { flex: 1, minHeight: 46, borderRadius: Tokens.radius.card, backgroundColor: themeColors.accentFill, alignItems: 'center', justifyContent: 'center' },
