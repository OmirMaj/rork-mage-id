...
const styles = StyleSheet.create({
  ...
  heading: { ...Type.display, color: Colors.ink, paddingHorizontal: Tokens.spacing.lg },
  subheading: { fontSize: Type.bodyCompact.fontSize, color: Colors.textMuted, paddingHorizontal: Tokens.spacing.lg, marginTop: Tokens.spacing.hairline, marginBottom: Tokens.spacing.md },
  portfolioRow: { flexDirection: 'row', flexWrap: 'wrap', paddingHorizontal: Tokens.spacing.sm, gap: Tokens.spacing.xs, marginBottom: Tokens.spacing.md },
  agingStrip: {
  ...
  agingStripHeader: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: Tokens.spacing.xs, marginBottom: 10 },
  ...
  agingBucketCell: { flex: 1, padding: Tokens.spacing.xs, borderRadius: Tokens.radius.sm, backgroundColor: Colors.surfaceAlt, alignItems: 'flex-start' as const },
  agingBucketValue: { fontSize: Type.bodyCompact.fontSize, fontWeight: '700' as const, letterSpacing: -0.2 },
  agingBucketLabel: { fontSize: 10, color: Colors.textMuted, fontWeight: '600' as const, marginTop: Tokens.spacing.hairline, textTransform: 'uppercase' as const, letterSpacing: 0.4 },
  portfolioStat: { flex: 1, minWidth: '46%' as any, backgroundColor: Colors.surface, borderRadius: Tokens.radius.lg, borderWidth: 1, borderColor: Colors.cardBorder, paddingVertical: Tokens.spacing.sm, paddingHorizontal: 14, gap: Tokens.spacing.xxs },
  ...
  card: { marginHorizontal: Tokens.spacing.md, marginBottom: Tokens.spacing.sm, backgroundColor: Colors.surface, borderRadius: Tokens.radius.xl, borderWidth: 1, borderColor: Colors.cardBorder, padding: 14, gap: 10 },
  cardHeader: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  cardTitle: { fontSize: Type.body.fontSize, fontWeight: '700' as const, color: Colors.text, letterSpacing: -0.2 },
  cardSubtitle: { fontSize: Type.caption1.fontSize, color: Colors.textMuted, marginTop: Tokens.spacing.hairline, textTransform: 'capitalize' as const },
  healthPill: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xxs, paddingHorizontal: Tokens.spacing.xs, paddingVertical: Tokens.spacing.xxs, borderRadius: Tokens.radius.sm },
  ...
  statGrid: { flexDirection: 'row', gap: Tokens.spacing.xs },
  stat: { flex: 1, backgroundColor: Colors.surfaceAlt, borderRadius: Tokens.radius.md, paddingVertical: Tokens.spacing.xs, paddingHorizontal: Tokens.spacing.xs, gap: Tokens.spacing.hairline, alignItems: 'flex-start' as const },
  ...
  milestoneRow: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: Colors.primary + '10', borderRadius: Tokens.radius.md, paddingVertical: Tokens.spacing.xs, paddingHorizontal: 10 },
  ...
  cardFooter: { flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end', gap: Tokens.spacing.xxs, marginTop: -2 },
  openDetailText: { fontSize: Type.caption1.fontSize, fontWeight: '600' as const, color: Colors.primary },
  emptyCard: { marginHorizontal: Tokens.spacing.md, padding: Tokens.spacing.xl, alignItems: 'center' as const, gap: 10, backgroundColor: Colors.surface, borderRadius: Tokens.radius.xl, borderWidth: 1, borderColor: Colors.cardBorder },
  ...
  reportsBody:  { fontSize: Type.caption1.fontSize, color: Colors.textSecondary, marginTop: Tokens.spacing.hairline, lineHeight: 16 },
  ...
  toolsCtaBody:  { fontSize: Type.caption1.fontSize, color: Colors.textSecondary, marginTop: Tokens.spacing.hairline, lineHeight: 16 },
});
