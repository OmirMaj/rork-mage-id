            ...
            <ScrollView style={{ flex: 1 }} contentContainerStyle={{ flexGrow: 1, justifyContent: 'flex-end' as const }} keyboardShouldPersistTaps="handled">
              <View style={[styles.formCard, { paddingBottom: insets.bottom + 20 }]}>
                ...
                <TouchableOpacity
                  ...
                  style={[styles.input, { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xs, paddingVertical: Tokens.spacing.sm, opacity: uploadingW9 ? 0.6 : 1 }]}
                >
                ...
                <TextInput style={[styles.input, { minHeight: 70, paddingTop: Tokens.spacing.sm, textAlignVertical: 'top' as const }]} value={notes} onChangeText={setNotes} placeholder="Additional notes..." placeholderTextColor={Colors.textMuted} multiline />
