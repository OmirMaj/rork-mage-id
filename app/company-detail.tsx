...
const styles = StyleSheet.create({
  ...
  avatarLarge: { width: 72, height: 72, borderRadius: 36, backgroundColor: Colors.primary + '15', alignItems: 'center', justifyContent: 'center', marginBottom: Tokens.spacing.sm },
  avatarLargeText: { fontSize: 30, fontWeight: '800' as const, color: Colors.primary },
  companyName: { fontSize: Type.title2.fontSize, fontWeight: '800' as const, color: Colors.text, marginBottom: Tokens.spacing.xxs, textAlign: 'center' as const },
  locationRow: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xxs, marginBottom: 6 },
  locationText: { fontSize: Type.bodyCompact.fontSize, color: Colors.textSecondary },
  ratingRow: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xxs },
  ...
  bidRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: Tokens.spacing.sm, borderBottomWidth: 0.5, borderBottomColor: Colors.borderLight },
  bidInfo: { flex: 1 },
  bidTitle: { fontSize: Type.subhead.fontSize, fontWeight: '600' as const, color: Colors.text, marginBottom: Tokens.spacing.hairline },
