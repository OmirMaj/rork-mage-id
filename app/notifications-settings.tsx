              ...
              <>
                ...
                <View style={styles.locationCard}>
                  <View style={styles.locationHeader}>
                    <MapPin size={14} color={locationCoverage.geocoded === locationCoverage.total ? Colors.success : '#7A4500'} />
...
const styles = StyleSheet.create({
  ...
  digestRowLabelText: {
    fontSize: Type.caption1.fontSize, color: Colors.textMuted, fontWeight: '600',
  ...
  hourPillText: { fontSize: Type.footnote.fontSize, fontWeight: '600', color: Colors.text },
  ...
  locationTitle: { fontSize: Type.footnote.fontSize, fontWeight: '700', color: Colors.text },
