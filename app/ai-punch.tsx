...
const makeStyles = (t: ThemeColors) => StyleSheet.create({
  ...
  sectionSub: { fontSize: Type.caption1.fontSize, color: t.textMuted, marginTop: 4 },

  sourceRow: { flexDirection: 'row', gap: 10 },
  sourceBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, paddingVertical: 14, backgroundColor: t.accent + '12', borderRadius: Tokens.radius.card, borderWidth: 1, borderColor: t.accent + '30' },
  sourceBtnText: { fontSize: Type.bodyCompact.fontSize, fontWeight: '600' as const, color: t.accent },
  ...
  galleryToggle: { fontSize: Type.footnote.fontSize, fontWeight: '600' as const, color: t.accent },
  ...
  galleryThumbPicked: { borderColor: t.accent },
  galleryImg: { width: '100%', height: '100%' },
  galleryCheck: { position: 'absolute', top: 4, right: 4, width: 22, height: 22, borderRadius: 11, backgroundColor: t.accent, alignItems: 'center', justifyContent: 'center' },
  ...
  noticeText: { flex: 1, fontSize: Type.footnote.fontSize, color: t.text, lineHeight: 18 },

  reviewHead: { flexDirection: 'row', alignItems: 'baseline', justifyContent: 'space-between' },
  reviewCard: { flexDirection: 'row', gap: 12, backgroundColor: t.surface, borderRadius: Tokens.radius.lg, padding: 12, borderWidth: 1, borderColor: t.line, marginBottom: 10 },
  reviewCardSaved: { backgroundColor: t.success + '0A', borderColor: t.success + '40' },
  ...
  reviewMeta: { fontSize: Type.caption2.fontSize, color: t.textMuted, fontWeight: '600' as const, textTransform: 'uppercase', letterSpacing: 0.5 },
  reviewInput: { backgroundColor: t.bg, borderRadius: Tokens.radius.sm, padding: 8, fontSize: Type.bodyCompact.fontSize, color: t.text, minHeight: 40, borderWidth: 1, borderColor: t.line },
  reviewInputSmall: { backgroundColor: t.bg, borderRadius: Tokens.radius.sm, paddingHorizontal: 8, paddingVertical: 6, fontSize: Type.footnote.fontSize, color: t.text, borderWidth: 1, borderColor: t.line },
  ...
  tradeText: { fontSize: Type.caption1.fontSize, color: t.textMuted, fontWeight: '600' as const },
