...
const styles = StyleSheet.create({
  ...
  profileHeader: { backgroundColor: Colors.surface, alignItems: 'center', paddingVertical: Tokens.spacing.xl, paddingHorizontal: Tokens.spacing.lg, borderBottomWidth: 0.5, borderBottomColor: Colors.borderLight },
  avatarLarge: { width: 72, height: 72, borderRadius: 36, backgroundColor: Colors.accent + '20', alignItems: 'center', justifyContent: 'center', marginBottom: Tokens.spacing.sm },
  avatarText: { fontSize: 30, fontWeight: '800' as const, color: Colors.accent },
  name: { fontSize: Type.title2.fontSize, fontWeight: '800' as const, color: Colors.text, marginBottom: Tokens.spacing.xxs },
  trade: { fontSize: Type.subhead.fontSize, color: Colors.textSecondary, marginBottom: Tokens.spacing.xs },
  availBadge: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: Tokens.spacing.sm, paddingVertical: 6, borderRadius: 20 },
  ...
  projectItem: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: Tokens.spacing.xs },
  ...
  jobInfo: { flex: 1 },
  jobTitle: { fontSize: Type.subhead.fontSize, fontWeight: '600' as const, color: Colors.text, marginBottom: Tokens.spacing.hairline },
  jobMeta: { fontSize: Type.footnote.fontSize, color: Colors.textSecondary },
  actionSection: { padding: Tokens.spacing.lg, gap: Tokens.spacing.sm },
  messageBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: Colors.primary, paddingVertical: Tokens.spacing.md, borderRadius: Tokens.radius.card, gap: Tokens.spacing.xs },
  messageBtnText: { color: '#FFF', fontSize: Type.callout.fontSize, fontWeight: '700' as const },
  contactRow: { flexDirection: 'row', gap: 10 },
  contactBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: Colors.primary + '12', paddingVertical: 14, borderRadius: Tokens.radius.card, gap: Tokens.spacing.xs },
