...
const styles = StyleSheet.create({
  ...
  benefits: { gap: 10, marginTop: Tokens.spacing.xxs },
  ...
  incompleteHint: { fontSize: Type.caption1.fontSize, color: Colors.textMuted, textAlign: 'center' as const, marginTop: Tokens.spacing.xxs },
  brandHint: { fontSize: Type.caption1.fontSize, color: Colors.textMuted, textAlign: 'center' as const, marginTop: Tokens.spacing.xxs },
  brandHintBold: { fontWeight: '700' as const, color: Colors.text },
  statRow: { flexDirection: 'row' as const, gap: 10, marginTop: Tokens.spacing.xxs },
  stat: { flex: 1, backgroundColor: Colors.surfaceAlt, borderRadius: Tokens.radius.card, padding: Tokens.spacing.sm, gap: Tokens.spacing.xxs },
