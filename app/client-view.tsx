...
const styles = StyleSheet.create({
  ...
  notFoundContainer: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: Tokens.spacing.sm, padding: Tokens.spacing['2xl'] },
  ...
  passcodeContainer: { flex: 1, backgroundColor: Colors.background, alignItems: 'center', justifyContent: 'center', padding: Tokens.spacing.xl },
  ...
  passcodeDesc: { fontSize: Type.footnote.fontSize, color: Colors.textMuted, textAlign: 'center', lineHeight: 18, marginTop: Tokens.spacing.xxs },
  passcodeInput: { width: '100%', minHeight: 50, borderRadius: Tokens.radius.card, backgroundColor: Colors.surfaceAlt, borderWidth: 1, borderColor: Colors.cardBorder, paddingHorizontal: 14, fontSize: Type.callout.fontSize, color: Colors.text, marginTop: Tokens.spacing.sm, textAlign: 'center', letterSpacing: 2 },
  passcodeErrorText: { fontSize: Type.caption1.fontSize, color: Colors.error, marginTop: Tokens.spacing.xxs },
  passcodeBtn: { width: '100%', minHeight: 50, borderRadius: Tokens.radius.card, backgroundColor: Colors.primary, alignItems: 'center', justifyContent: 'center', marginTop: Tokens.spacing.sm },
  ...
  headerBrand: { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: Tokens.spacing.sm, opacity: 0.8 },
  headerBrandText: { fontSize: Type.caption1.fontSize, fontWeight: '600', color: '#FFF', letterSpacing: 1 },
  headerProjectName: { fontSize: 24, fontWeight: '800', color: '#FFF', marginBottom: Tokens.spacing.xxs },
  headerLocation: { fontSize: Type.footnote.fontSize, color: '#FFFFFF99', marginBottom: Tokens.spacing.xxs },
  headerLastUpdated: { fontSize: Type.caption2.fontSize, color: '#FFFFFF80', marginBottom: Tokens.spacing.sm, fontStyle: 'italic' as const },
  statusBadge: { borderRadius: Tokens.radius.sm, paddingHorizontal: 10, paddingVertical: Tokens.spacing.xxs },
  statusBadgeText: { fontSize: Type.caption1.fontSize, fontWeight: '700' },

  welcomeCard: {
    flexDirection: 'row', alignItems: 'flex-start', gap: 10,
    margin: Tokens.spacing.md, backgroundColor: Colors.primary + '10',
  ...
  closeoutHeader: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: Tokens.spacing.sm, marginBottom: Tokens.spacing.xs },
  ...
  closeoutBody: { fontSize: Type.bodyCompact.fontSize, color: Colors.text, lineHeight: 20, marginBottom: Tokens.spacing.xs },
  closeoutMaintenanceList: { marginTop: 6, gap: Tokens.spacing.xxs },
  ...
  decisionsCard: { marginHorizontal: Tokens.spacing.md, marginTop: Tokens.spacing.xxs, marginBottom: Tokens.spacing.sm, padding: 14, borderRadius: Tokens.radius.lg, backgroundColor: '#FFF3E0', borderWidth: 1, borderColor: '#FFC10733' },
  ...
  decisionRow: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: Tokens.spacing.xs, paddingVertical: Tokens.spacing.xs, borderTopWidth: 1, borderTopColor: '#FFC10722' },
  ...
  statsRow: { flexDirection: 'row', paddingHorizontal: Tokens.spacing.md, gap: 10, marginBottom: Tokens.spacing.xs },
  statCard: {
    flex: 1, backgroundColor: Colors.card,
    borderRadius: Tokens.radius.card, padding: Tokens.spacing.sm, alignItems: 'center',
    borderWidth: 1, borderColor: Colors.border,
  },
  statLabel: { fontSize: Type.caption2.fontSize, color: Colors.textMuted, fontWeight: '600', marginBottom: Tokens.spacing.xxs },
  statValue: { fontSize: Type.title3.fontSize, fontWeight: '800', color: Colors.text },
  statSub: { fontSize: 10, color: Colors.textMuted, marginTop: Tokens.spacing.hairline },
  ...
  badge: { backgroundColor: Colors.primary + '20', borderRadius: Tokens.radius.md, paddingHorizontal: 7, paddingVertical: Tokens.spacing.hairline },
  badgeText: { fontSize: Type.caption2.fontSize, fontWeight: '700', color: Colors.primary },

  sectionBody: { padding: Tokens.spacing.sm, gap: Tokens.spacing.xs },

  // Health bar
  healthRow: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xs, marginBottom: Tokens.spacing.xs },
  ...
  // Task rows
  taskRow: { flexDirection: 'row', backgroundColor: Colors.background, borderRadius: Tokens.radius.sm, overflow: 'hidden', marginBottom: Tokens.spacing.xxs },
  taskPhaseBar: { width: 3 },
  taskContent: { flex: 1, padding: 10 },
  taskTitleRow: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xxs, marginBottom: Tokens.spacing.hairline },
  ...
  budgetRowTotal: { borderTopWidth: 1, borderTopColor: Colors.border, marginTop: Tokens.spacing.xxs, paddingTop: 10 },
  ...
  invoiceProgressRow: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xs, marginTop: Tokens.spacing.xs },
  ...
  listRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: Colors.background, borderRadius: Tokens.radius.sm, padding: 10, marginBottom: Tokens.spacing.xxs },
  listRowLeft: { flex: 1, marginRight: 10 },
  listRowTitle: { fontSize: Type.footnote.fontSize, fontWeight: '600', color: Colors.text, marginBottom: Tokens.spacing.hairline },
  listRowMeta: { fontSize: Type.caption2.fontSize, color: Colors.textMuted },
  listRowRight: { alignItems: 'flex-end', gap: Tokens.spacing.xxs },
  ...
  selCardHead: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: Tokens.spacing.xs },
  ...
  selProductMeta: { fontSize: Type.caption1.fontSize, color: Colors.textSecondary, marginTop: Tokens.spacing.hairline },
  selPlaceholder: { fontSize: Type.caption1.fontSize, color: Colors.textMuted, fontStyle: 'italic' as const },
  selBudgetRow: { flexDirection: 'row' as const, justifyContent: 'space-between' as const, alignItems: 'center' as const, gap: Tokens.spacing.xs },
  ...
  selOptionGrid: { flexDirection: 'row' as const, flexWrap: 'wrap' as const, gap: Tokens.spacing.xs, marginTop: Tokens.spacing.xs },
  selOptionTile: {
    width: '48%' as const,
  ...
  selOptionName: { fontSize: Type.caption2.fontSize, fontWeight: '700' as const, color: Colors.text, marginTop: Tokens.spacing.xxs },
  ...
  scheduleMore: { fontSize: Type.caption2.fontSize, color: Colors.textMuted, fontStyle: 'italic' as const, paddingTop: Tokens.spacing.xs, paddingHorizontal: 6 },
  listStatusText: { fontSize: 10, fontWeight: '700', color: Colors.textMuted },

  // Photos
  photoGrid: { flexDirection: 'row', flexWrap: 'wrap', padding: Tokens.spacing.sm, gap: Tokens.spacing.xxs },
  ...
  photoTag: { position: 'absolute', bottom: 4, left: 4, backgroundColor: '#00000080', borderRadius: 4, paddingHorizontal: Tokens.spacing.xxs, paddingVertical: Tokens.spacing.hairline },
  ...
  footer: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, marginTop: Tokens.spacing.xs },
  ...
  coActions: {
    flexDirection: 'row', gap: Tokens.spacing.xs, paddingHorizontal: 10, paddingBottom: 10,
  ...
  coSignedBanner: {
    ...
    backgroundColor: '#34C75915', paddingHorizontal: 10, paddingVertical: Tokens.spacing.xs,
  ...
  emptyDocs: { alignItems: 'center', padding: Tokens.spacing.lg, gap: 6 },
  ...
  msgList: { gap: Tokens.spacing.xs, paddingBottom: Tokens.spacing.sm },
  msgRow: { flexDirection: 'row' },
  msgRowMine: { justifyContent: 'flex-end' },
  msgRowTheirs: { justifyContent: 'flex-start' },
  msgBubble: {
    maxWidth: '84%', borderRadius: Tokens.radius.card, paddingHorizontal: Tokens.spacing.sm, paddingVertical: Tokens.spacing.xs,
  },
  ...
  msgAuthor: { fontSize: Type.caption2.fontSize, fontWeight: '700', color: Colors.textSecondary, marginBottom: Tokens.spacing.hairline },
  ...
  msgTime: { fontSize: 10, color: Colors.textMuted, marginTop: Tokens.spacing.xxs },
  ...
  modalCard: {
    ...
    maxHeight: '90%', paddingBottom: Tokens.spacing.lg,
  },
  modalHeader: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between',
    paddingHorizontal: Tokens.spacing.lg, paddingTop: Tokens.spacing.md, paddingBottom: Tokens.spacing.sm,
  ...
  modalBody: { paddingHorizontal: Tokens.spacing.lg, paddingTop: 14 },
  modalSummary: {
    backgroundColor: Colors.surface, borderRadius: Tokens.radius.card, padding: 14,
    borderWidth: 1, borderColor: Colors.border, marginBottom: Tokens.spacing.md,
  },
  modalSummaryLabel: { fontSize: Type.caption2.fontSize, color: Colors.textMuted, fontWeight: '600', marginBottom: Tokens.spacing.xxs, letterSpacing: 0.5 },
  modalSummaryTitle: { fontSize: Type.subhead.fontSize, fontWeight: '700', color: Colors.text, marginBottom: 10 },
  modalSummaryRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: Tokens.spacing.xxs },
  ...
  modalSummaryReason: { fontSize: Type.caption1.fontSize, color: Colors.textMuted, marginTop: Tokens.spacing.xs, fontStyle: 'italic', lineHeight: 17 },
  modalFieldLabel: { fontSize: Type.footnote.fontSize, fontWeight: '600', color: Colors.text, marginBottom: 6, marginTop: Tokens.spacing.xxs },
  ...
  modalInput: {
    ...
    paddingHorizontal: Tokens.spacing.sm, paddingVertical: 10, fontSize: Type.bodyCompact.fontSize, color: Colors.text, marginBottom: 14,
  },
  ...
  modalActions: {
    flexDirection: 'row', gap: 10, paddingHorizontal: Tokens.spacing.lg, paddingTop: Tokens.spacing.sm,
  ...
  modalSubmitBtn: {
    flex: 2, flexDirection: 'row', gap: Tokens.spacing.xs, paddingVertical: 13, borderRadius: Tokens.radius.card,
