    ...
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
      ...
      >
        ...
        {(existingRFI && (status === 'answered' || status === 'closed')) && (
          <>
            <Text style={[styles.fieldLabel, { marginTop: Tokens.spacing.lg }]}>Response</Text>
            <TextInput
              style={[styles.input, styles.multilineInput]}
              value={response}
...
const styles = StyleSheet.create({
  ...
  linkedTaskBadge: {
    ...
    paddingHorizontal: 10, paddingVertical: Tokens.spacing.xs, marginTop: 6,
  },
  ...
  unlinkBtn: { padding: Tokens.spacing.hairline },
  modalOverlay: { flex: 1, backgroundColor: '#00000060', justifyContent: 'center', alignItems: 'center', padding: Tokens.spacing.xl },
  ...
  handoffLog: {
    paddingTop: Tokens.spacing.xs, borderTopWidth: 0.5, borderTopColor: Colors.borderLight,
    gap: Tokens.spacing.xxs,
  },
  handoffLogLabel: {
    fontSize: 10, fontWeight: '800' as const, color: Colors.textMuted,
    letterSpacing: 0.5, textTransform: 'uppercase' as const, marginBottom: Tokens.spacing.xxs,
  },
  handoffRow: { gap: 1 },
