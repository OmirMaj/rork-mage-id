...
// constraints + commitments persist via hooks/useLastPlanner, which also mirrors
// them to Supabase (the local store alone was swept on every sign-out and never
// reached a second device). The cloud load lives in the hook, not here, so the
// Friday Close card and Ask refill without this screen ever being opened.
