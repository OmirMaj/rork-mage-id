...
const CONTACT_ROLES: { value: ContactRole; label: string }[] = [
  ...
  // Building side. On a tenant fit-out these three are among the people a PM
  // talks to most, and until now each of them had to be filed as 'Other' —
...
const makeStyles = (t: ThemeColors) => StyleSheet.create({
  ...
  filterChipActive: { backgroundColor: t.accentFill },
  ...
  roleChipActive: { backgroundColor: t.accentFill },
  ...
  saveBtn: { backgroundColor: t.accentFill, borderRadius: Tokens.radius.lg, paddingVertical: 14, alignItems: 'center', marginTop: 16 },
