...
function makeStyles(c: ThemedPalette) {
  return StyleSheet.create({
    ...
    headerAddBtn: { marginRight: Tokens.spacing.xs, width: 36, height: 36, borderRadius: Tokens.radius.xl, backgroundColor: c.primary + '12', alignItems: 'center', justifyContent: 'center' },
    searchSection: { backgroundColor: c.surface, paddingBottom: 10, borderBottomWidth: 0.5, borderBottomColor: c.borderLight },
    searchBar: { flexDirection: 'row', alignItems: 'center', backgroundColor: c.fillTertiary, borderRadius: Tokens.radius.card, marginHorizontal: Tokens.spacing.md, paddingHorizontal: Tokens.spacing.sm, gap: Tokens.spacing.xs, height: 42 },
    searchInput: { flex: 1, fontSize: Type.subhead.fontSize, color: c.text },
    filterRow: { paddingHorizontal: Tokens.spacing.md, gap: 6, marginTop: Tokens.spacing.xs },
    filterChip: { paddingHorizontal: Tokens.spacing.sm, paddingVertical: 6, borderRadius: 20, backgroundColor: c.fillTertiary },
    filterChipActive: { backgroundColor: c.primary },
    filterChipText: { fontSize: Type.caption1.fontSize, fontWeight: '500' as const, color: c.textSecondary },
    filterChipTextActive: { color: Colors.textOnPrimary, fontWeight: '600' as const },
    listContent: { paddingHorizontal: Tokens.spacing.md, paddingTop: Tokens.spacing.sm, gap: Tokens.spacing.xs },
    contactCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: c.card, borderRadius: Tokens.radius.lg, padding: 14, gap: Tokens.spacing.sm, borderWidth: 1, borderColor: c.cardBorder },
    avatar: { width: 44, height: 44, borderRadius: 22, alignItems: 'center', justifyContent: 'center' },
    avatarText: { fontSize: Type.subheadline.fontSize, fontWeight: '700' as const },
    contactInfo: { flex: 1, gap: Tokens.spacing.hairline },
    contactName: { fontSize: Type.subhead.fontSize, fontWeight: '600' as const, color: c.text },
    contactCompany: { fontSize: Type.caption1.fontSize, color: c.textSecondary },
    contactMetaRow: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xs, marginTop: Tokens.spacing.hairline },
    roleBadge: { paddingHorizontal: Tokens.spacing.xs, paddingVertical: Tokens.spacing.hairline, borderRadius: Tokens.radius.xs },
    roleBadgeText: { fontSize: 10, fontWeight: '700' as const },
    contactEmail: { fontSize: Type.caption2.fontSize, color: c.textMuted, flex: 1 },
    emptyState: { alignItems: 'center', paddingVertical: 60, gap: 10 },
    emptyTitle: { fontSize: Type.body.fontSize, fontWeight: '600' as const, color: c.text },
    emptyDesc: { fontSize: Type.bodyCompact.fontSize, color: c.textMuted, textAlign: 'center' as const },
    modalOverlay: { flex: 1, backgroundColor: c.overlay, justifyContent: 'flex-end' },
    modalCard: { backgroundColor: c.surface, borderTopLeftRadius: 28, borderTopRightRadius: 28, padding: 22 },
    modalHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: Tokens.spacing.sm },
    modalTitle: { fontSize: Type.title3.fontSize, fontWeight: '700' as const, color: c.text },
    formRow: { flexDirection: 'row', gap: 10 },
    formLabel: { fontSize: Type.caption1.fontSize, fontWeight: '600' as const, color: c.textSecondary, marginTop: 10, marginBottom: Tokens.spacing.xxs, textTransform: 'uppercase' as const, letterSpacing: 0.5 },
    formInput: { minHeight: 44, borderRadius: Tokens.radius.card, backgroundColor: c.surfaceAlt, paddingHorizontal: Tokens.spacing.sm, fontSize: Type.subhead.fontSize, color: c.text, borderWidth: 1, borderColor: c.cardBorder },
    roleChipsRow: { gap: 6, paddingVertical: Tokens.spacing.hairline },
    roleChip: { paddingHorizontal: Tokens.spacing.sm, paddingVertical: 7, borderRadius: Tokens.radius.md, backgroundColor: c.fillTertiary },
    roleChipActive: { backgroundColor: c.primary },
    roleChipText: { fontSize: Type.footnote.fontSize, fontWeight: '500' as const, color: c.textSecondary },
    roleChipTextActive: { color: Colors.textOnPrimary, fontWeight: '600' as const },
    saveBtn: { backgroundColor: c.primary, borderRadius: Tokens.radius.lg, paddingVertical: 14, alignItems: 'center', marginTop: Tokens.spacing.md },
    saveBtnText: { fontSize: Type.callout.fontSize, fontWeight: '700' as const, color: Colors.textOnPrimary },
    detailRoleBadge: { flexDirection: 'row', alignItems: 'center', gap: 6, alignSelf: 'flex-start', paddingHorizontal: Tokens.spacing.sm, paddingVertical: 6, borderRadius: Tokens.radius.md, marginBottom: Tokens.spacing.sm },
    detailRoleText: { fontSize: Type.footnote.fontSize, fontWeight: '700' as const },
    detailCompany: { fontSize: Type.caption1.fontSize, color: c.textSecondary },
    detailSection: { gap: 10, marginBottom: Tokens.spacing.md },
    detailRow: { flexDirection: 'row', alignItems: 'center', gap: 10 },
    detailText: { fontSize: Type.bodyCompact.fontSize, color: c.text },
    financialCard: { backgroundColor: c.surfaceAlt, borderRadius: Tokens.radius.lg, padding: 14, gap: Tokens.spacing.xs, marginBottom: Tokens.spacing.md },
    financialTitle: { fontSize: Type.footnote.fontSize, fontWeight: '700' as const, color: c.textSecondary, textTransform: 'uppercase' as const, letterSpacing: 0.5, marginBottom: Tokens.spacing.xxs },
    financialRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    financialLabel: { fontSize: Type.bodyCompact.fontSize, color: c.textSecondary },
    financialValue: { fontSize: Type.bodyCompact.fontSize, fontWeight: '600' as const, color: c.text },
    financialDivider: { height: 1, backgroundColor: c.borderLight },
    financialLabelBold: { fontSize: Type.subhead.fontSize, fontWeight: '700' as const, color: c.text },
    financialValueBold: { fontSize: Type.body.fontSize, fontWeight: '800' as const },
    linkedSection: { marginBottom: Tokens.spacing.md },
    linkedTitle: { fontSize: Type.footnote.fontSize, fontWeight: '700' as const, color: c.textSecondary, textTransform: 'uppercase' as const, letterSpacing: 0.5, marginBottom: Tokens.spacing.xs },
    linkedProjectRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: c.surfaceAlt, borderRadius: Tokens.radius.md, padding: Tokens.spacing.sm, marginBottom: Tokens.spacing.xxs },
    linkedProjectName: { fontSize: Type.bodyCompact.fontSize, fontWeight: '500' as const, color: c.text },
    notesSection: { marginBottom: Tokens.spacing.md },
    notesTitle: { fontSize: Type.footnote.fontSize, fontWeight: '700' as const, color: c.textSecondary, textTransform: 'uppercase' as const, letterSpacing: 0.5, marginBottom: 6 },
    notesText: { fontSize: Type.bodyCompact.fontSize, color: c.text, lineHeight: 20 },
    detailActions: { flexDirection: 'row', gap: 10, marginTop: Tokens.spacing.xs },
    editBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: c.primary + '12', borderRadius: Tokens.radius.card, paddingVertical: Tokens.spacing.sm },
    editBtnText: { fontSize: Type.bodyCompact.fontSize, fontWeight: '600' as const, color: c.primary },
    deleteBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: Colors.errorLight, borderRadius: Tokens.radius.card, paddingVertical: Tokens.spacing.sm },
