...
const styles = StyleSheet.create({
  ...
  headerAddBtn: { marginRight: Tokens.spacing.xs, width: 36, height: 36, borderRadius: Tokens.radius.xl, backgroundColor: Colors.primary + '12', alignItems: 'center', justifyContent: 'center' },
  searchSection: { backgroundColor: Colors.surface, paddingBottom: 10, borderBottomWidth: 0.5, borderBottomColor: Colors.borderLight },
  searchBar: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.fillTertiary, borderRadius: Tokens.radius.card, marginHorizontal: Tokens.spacing.md, paddingHorizontal: Tokens.spacing.sm, gap: Tokens.spacing.xs, height: 42 },
  ...
  filterChip: { paddingHorizontal: Tokens.spacing.sm, paddingVertical: 6, borderRadius: 20, backgroundColor: Colors.fillTertiary },
  ...
  contactCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.card, borderRadius: Tokens.radius.lg, padding: 14, gap: Tokens.spacing.sm, borderWidth: 1, borderColor: Colors.cardBorder },
  ...
  formLabel: { fontSize: Type.caption1.fontSize, fontWeight: '600' as const, color: Colors.textSecondary, marginTop: 10, marginBottom: Tokens.spacing.xxs, textTransform: 'uppercase' as const, letterSpacing: 0.5 },
  formInput: { minHeight: 44, borderRadius: Tokens.radius.card, backgroundColor: Colors.surfaceAlt, paddingHorizontal: Tokens.spacing.sm, fontSize: Type.subhead.fontSize, color: Colors.text, borderWidth: 1, borderColor: Colors.cardBorder },
  roleChipsRow: { gap: 6, paddingVertical: Tokens.spacing.hairline },
  roleChip: { paddingHorizontal: Tokens.spacing.sm, paddingVertical: 7, borderRadius: Tokens.radius.md, backgroundColor: Colors.fillTertiary },
  ...
  saveBtn: { backgroundColor: Colors.primary, borderRadius: Tokens.radius.lg, paddingVertical: 14, alignItems: 'center', marginTop: Tokens.spacing.md },
  ...
  financialCard: { backgroundColor: Colors.surfaceAlt, borderRadius: Tokens.radius.lg, padding: 14, gap: Tokens.spacing.xs, marginBottom: Tokens.spacing.md },
  financialTitle: { fontSize: Type.footnote.fontSize, fontWeight: '700' as const, color: Colors.textSecondary, textTransform: 'uppercase' as const, letterSpacing: 0.5, marginBottom: Tokens.spacing.xxs },
  ...
  linkedTitle: { fontSize: Type.footnote.fontSize, fontWeight: '700' as const, color: Colors.textSecondary, textTransform: 'uppercase' as const, letterSpacing: 0.5, marginBottom: Tokens.spacing.xs },
  linkedProjectRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: Colors.surfaceAlt, borderRadius: Tokens.radius.md, padding: Tokens.spacing.sm, marginBottom: Tokens.spacing.xxs },
  ...
  editBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: Colors.primary + '12', borderRadius: Tokens.radius.card, paddingVertical: Tokens.spacing.sm },
