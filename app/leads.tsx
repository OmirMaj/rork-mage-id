...
const styles = StyleSheet.create({
  ...
  kpiLabel: { fontSize: Type.caption2.fontSize, color: Colors.textMuted, marginTop: Tokens.spacing.hairline, fontWeight: '500' as const },
  kpiDivider: { width: StyleSheet.hairlineWidth, height: 32, backgroundColor: Colors.cardBorder },
  columnsRow: { paddingHorizontal: Tokens.spacing.sm, paddingTop: Tokens.spacing.sm, paddingBottom: 100, gap: Tokens.spacing.sm },
  column: {
    width: 280,
  ...
  cardsCol: { gap: Tokens.spacing.xs, paddingBottom: Tokens.spacing.sm },
  emptyColumn: { fontSize: Type.footnote.fontSize, color: Colors.textMuted, textAlign: 'center', paddingTop: Tokens.spacing.md },
  emptyBanner: {
  ...
  cardContactRow: { flexDirection: 'row', alignItems: 'center', gap: 5, marginTop: Tokens.spacing.hairline },
