...
const styles = StyleSheet.create({
  ...
  exportRow: { flexDirection: 'row' as const, gap: 10, marginTop: Tokens.spacing.sm },
  exportBtn: { flex: 1, flexDirection: 'row' as const, alignItems: 'center' as const, justifyContent: 'center' as const, gap: Tokens.spacing.xs, paddingVertical: Tokens.spacing.sm, borderRadius: Tokens.radius.md, borderWidth: 1, borderColor: Colors.cardBorder, backgroundColor: Colors.card },
  ...
  emailModalCard: { backgroundColor: Colors.card, marginHorizontal: Tokens.spacing.md, padding: Tokens.spacing.lg, borderRadius: Tokens.radius.panel, gap: 6, borderWidth: 1, borderColor: Colors.cardBorder },
  emailModalHeader: { flexDirection: 'row' as const, alignItems: 'center' as const, justifyContent: 'space-between' as const, marginBottom: Tokens.spacing.xs },
  ...
  emailInput: { backgroundColor: Colors.fillTertiary, borderRadius: Tokens.radius.md, paddingHorizontal: 14, paddingVertical: Tokens.spacing.sm, fontSize: Type.subhead.fontSize, color: Colors.text },
  emailSendBtn: { marginTop: Tokens.spacing.md, flexDirection: 'row' as const, alignItems: 'center' as const, justifyContent: 'center' as const, gap: Tokens.spacing.xs, backgroundColor: Colors.primary, paddingVertical: 14, borderRadius: Tokens.radius.card },
  emailSendBtnText: { color: '#fff', fontSize: Type.subhead.fontSize, fontWeight: '700' as const },
  pickerBtn: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: Tokens.spacing.xs, backgroundColor: Colors.surface, borderRadius: Tokens.radius.card, paddingHorizontal: 14, paddingVertical: Tokens.spacing.sm, borderWidth: 1, borderColor: Colors.cardBorder },
  pickerBtnText: { flex: 1, fontSize: Type.subhead.fontSize, color: Colors.text },
  linkedTaskBadge: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: Tokens.spacing.xs, backgroundColor: Colors.primary + '10', borderRadius: Tokens.radius.sm, paddingHorizontal: 10, paddingVertical: Tokens.spacing.xs, marginTop: 6 },
  ...
  modalOverlay: { flex: 1, backgroundColor: '#00000060', justifyContent: 'center' as const, alignItems: 'center' as const, padding: Tokens.spacing.xl },
  taskPickerCard: { backgroundColor: Colors.surface, borderRadius: Tokens.radius.panel, width: '100%', overflow: 'hidden' as const },
  taskPickerHeader: { flexDirection: 'row' as const, alignItems: 'center' as const, justifyContent: 'space-between' as const, padding: Tokens.spacing.md, borderBottomWidth: 1, borderBottomColor: Colors.cardBorder },
  taskPickerTitle: { fontSize: Type.callout.fontSize, fontWeight: '700' as const, color: Colors.text },
  taskOption: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: 10, padding: Tokens.spacing.sm, borderBottomWidth: 1, borderBottomColor: Colors.cardBorder + '80' },
