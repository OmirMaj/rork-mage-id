  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: insets.bottom + 30 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={{ flexDirection: 'row', gap: 10, marginHorizontal: Tokens.spacing.md, marginVertical: Tokens.spacing.sm }}>
          <TouchableOpacity
          ...
          <View style={{ flexDirection: 'row' as const, gap: Tokens.spacing.xs }}>
            <TouchableOpacity
              style={{
                ...
                paddingVertical: 14, paddingHorizontal: Tokens.spacing.md,
...
const styles = StyleSheet.create({
  ...
  statIconWrap: { width: 32, height: 32, borderRadius: Tokens.radius.sm, alignItems: 'center', justifyContent: 'center', marginBottom: Tokens.spacing.xs },
  statValue: { fontSize: Type.title3.fontSize, fontWeight: '700' as const, color: Colors.text, letterSpacing: -0.3 },
  statLabel: { fontSize: Type.caption2.fontSize, color: Colors.textSecondary, marginTop: Tokens.spacing.hairline },
  clockInButton: {
  ...
  listSection: { paddingHorizontal: Tokens.spacing.md },
  liveCard: {
    marginBottom: 10,
    borderRadius: Tokens.radius.lg,
    backgroundColor: Colors.surface,
  ...
  liveCardInner: { padding: 14, gap: Tokens.spacing.xs },
  liveCardHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  liveCardNameRow: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xs },
  statusDot: { width: 8, height: 8, borderRadius: 4 },
  liveCardName: { fontSize: Type.callout.fontSize, fontWeight: '600' as const, color: Colors.text },
  liveStatusBadge: { paddingHorizontal: 10, paddingVertical: Tokens.spacing.xxs, borderRadius: Tokens.radius.sm },
  ...
  liveCardActions: { flexDirection: 'row', gap: Tokens.spacing.xs, marginTop: Tokens.spacing.xxs },
  actionBtn: {
    flex: 1,
    flexDirection: 'row',
    alignItems: 'center',
  ...
  historyFooter: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: Tokens.spacing.xxs },
  historyDate: { fontSize: Type.caption1.fontSize, color: Colors.textMuted },
  otBadge: { backgroundColor: Colors.warningLight, paddingHorizontal: Tokens.spacing.xs, paddingVertical: 3, borderRadius: Tokens.radius.xs },
  otBadgeText: { fontSize: Type.caption2.fontSize, fontWeight: '600' as const, color: Colors.warningDark },
  emptyState: { alignItems: 'center', paddingVertical: 60, paddingHorizontal: Tokens.spacing['2xl'], gap: Tokens.spacing.xs },
  ...
  emptyCtaBtn: { marginTop: Tokens.spacing.sm, paddingHorizontal: Tokens.spacing.lg, paddingVertical: 10, backgroundColor: Colors.primary, borderRadius: Tokens.radius.md },
  ...
  modalSubtitle: { fontSize: Type.bodyCompact.fontSize, color: Colors.textSecondary, marginBottom: Tokens.spacing.md },
  memberRow: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  memberInfo: { flex: 1, gap: Tokens.spacing.hairline },
  ...
  allClockedIn: { textAlign: 'center' as const, color: Colors.textMuted, paddingVertical: Tokens.spacing.lg, fontSize: Type.bodyCompact.fontSize },
  // Worker-roster empty state + add-worker styles.
  emptyRosterWrap: { alignItems: 'center' as const, paddingVertical: 28, paddingHorizontal: Tokens.spacing.md, gap: Tokens.spacing.xs },
  ...
  addWorkerLabel: { fontSize: Type.caption1.fontSize, fontWeight: '600' as const, color: Colors.textSecondary, marginTop: Tokens.spacing.xs },
  addWorkerInput: {
    minHeight: 44,
    borderRadius: Tokens.radius.card,
  ...
  projectPickerValue: { fontSize: Type.subhead.fontSize, color: Colors.text, fontWeight: '600' as const, marginTop: Tokens.spacing.hairline },
  projectListWrap: {
    backgroundColor: Colors.surface,
    borderRadius: Tokens.radius.lg,
    borderWidth: 0.5,
