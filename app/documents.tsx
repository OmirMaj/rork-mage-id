...
const styles = StyleSheet.create({
  ...
  alertsRow: { paddingHorizontal: Tokens.spacing.md, paddingTop: Tokens.spacing.md, gap: Tokens.spacing.xs },
  alertCard: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 10,
  ...
  docTypeTag: { alignSelf: 'flex-start', paddingHorizontal: 10, paddingVertical: Tokens.spacing.xxs, borderRadius: Tokens.radius.xs },
  ...
  docFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: Tokens.spacing.xxs },
  docStatusBadge: {
    flexDirection: 'row',
    alignItems: 'center',
