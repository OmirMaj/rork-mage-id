...
const styles = StyleSheet.create({
  ...
  hero: {
    margin: 16, padding: 20, borderRadius: Tokens.radius.lg,
  ...
  heroLabel: { fontSize: Type.caption2.fontSize, fontWeight: '800' as const, color: Colors.primary, letterSpacing: 0.6, textTransform: 'uppercase' as const, marginTop: 8 },
  heroScore: { fontSize: 44, fontWeight: '900' as const, color: Colors.text, letterSpacing: -1.4, marginTop: 2 },
  ...
  heroChipRow: { flexDirection: 'row' as const, gap: 8, marginTop: 12 },
  ...
  loadingText: { fontSize: Type.subheadline.fontSize, fontWeight: '700' as const, color: Colors.text, marginTop: 8, textAlign: 'center' as const },
  ...
  sectionBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: Tokens.radius.sm, backgroundColor: Colors.fillTertiary, minWidth: 22, alignItems: 'center' as const },
  ...
  cardHead: { flexDirection: 'row' as const, alignItems: 'flex-start' as const, gap: 8, marginBottom: 4 },
  ...
  costPill: { alignSelf: 'flex-start' as const, paddingHorizontal: 8, paddingVertical: 3, borderRadius: Tokens.radius.sm, marginTop: 8 },
  costPillText: { fontSize: 11, fontWeight: '800' as const, letterSpacing: 0.2 },

  emptyCard: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: 8, padding: 12, borderRadius: Tokens.radius.md, backgroundColor: Colors.success + '0A', borderWidth: 1, borderColor: Colors.success + '25' },
  ...
  doneBtn: { marginHorizontal: 16, marginTop: 6, minHeight: 50, borderRadius: 999, backgroundColor: Colors.primary, alignItems: 'center' as const, justifyContent: 'center' as const },
