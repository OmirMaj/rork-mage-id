          ...
          <View style={styles.modalOverlay}>
            <View style={[styles.modalCard, { paddingBottom: insets.bottom + 16 }]}>
              <View style={styles.modalHeader}>
                ...
                <TouchableOpacity onPress={() => setShowAddItem(false)} accessibilityRole="button" accessibilityLabel="Close"><X size={20} color={Colors.textMuted} /></TouchableOpacity>
              </View>
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.modalCard, { paddingBottom: insets.bottom + 16, maxHeight: '70%' }]}>
            <View style={styles.modalHeader}>
              ...
              <TouchableOpacity onPress={() => setShowEstimateItems(false)} accessibilityRole="button" accessibilityLabel="Close"><X size={20} color={Colors.textMuted} /></TouchableOpacity>
            </View>
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.modalCard, { paddingBottom: insets.bottom + 16, maxHeight: '80%' }]}>
            <View style={styles.modalHeader}>
              ...
              <TouchableOpacity onPress={() => setShowMaterialSearch(false)} accessibilityRole="button" accessibilityLabel="Close"><X size={20} color={Colors.textMuted} /></TouchableOpacity>
            </View>
...
const pipelineWrapStyle = { paddingHorizontal: Tokens.spacing.md, marginTop: Tokens.spacing.sm, marginBottom: Tokens.spacing.xs } as const;
...
const styles = StyleSheet.create({
  ...
  heroCard: { backgroundColor: Colors.primary, marginHorizontal: Tokens.spacing.lg, marginTop: Tokens.spacing.md, borderRadius: Tokens.radius.panel, padding: Tokens.spacing.lg, gap: Tokens.spacing.xxs },
  ...
  totalsCard: { marginHorizontal: Tokens.spacing.lg, marginTop: Tokens.spacing.md, backgroundColor: Colors.card, borderRadius: Tokens.radius.panel, padding: 18, borderWidth: 1, borderColor: Colors.cardBorder },
  ...
  divider: { height: 1, backgroundColor: Colors.borderLight, marginVertical: Tokens.spacing.xxs },
  ...
  fieldSection: { marginHorizontal: Tokens.spacing.lg, marginTop: 18 },
  fieldLabel: { fontSize: Type.footnote.fontSize, fontWeight: '600' as const, color: Colors.textSecondary, marginBottom: 6, textTransform: 'uppercase' as const, letterSpacing: 0.5 },
  helperText: { fontSize: Type.caption2.fontSize, color: Colors.textMuted, marginTop: 6, fontStyle: 'italic' as const },
  input: { minHeight: 48, borderRadius: Tokens.radius.lg, backgroundColor: Colors.card, paddingHorizontal: 14, fontSize: Type.subhead.fontSize, color: Colors.text, borderWidth: 1, borderColor: Colors.cardBorder },
  textArea: { minHeight: 90, borderRadius: Tokens.radius.lg, backgroundColor: Colors.card, paddingHorizontal: 14, paddingTop: Tokens.spacing.sm, fontSize: Type.subhead.fontSize, color: Colors.text, borderWidth: 1, borderColor: Colors.cardBorder },
  sectionHeaderRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: Tokens.spacing.xs },
  addBtnRow: { flexDirection: 'row', gap: Tokens.spacing.xs },
  addFromBtn: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xxs, paddingHorizontal: 10, paddingVertical: 6, borderRadius: Tokens.radius.sm, backgroundColor: Colors.infoLight },
  addFromBtnText: { fontSize: Type.caption1.fontSize, fontWeight: '600' as const, color: Colors.info },
  addNewBtn: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xxs, paddingHorizontal: 10, paddingVertical: 6, borderRadius: Tokens.radius.sm, backgroundColor: Colors.primary + '15' },
  addNewBtnText: { fontSize: Type.caption1.fontSize, fontWeight: '600' as const, color: Colors.primary },
  emptyItems: { backgroundColor: Colors.card, borderRadius: Tokens.radius.card, padding: Tokens.spacing.xl, alignItems: 'center', borderWidth: 1, borderColor: Colors.cardBorder },
  emptyItemsText: { fontSize: Type.bodyCompact.fontSize, color: Colors.textMuted, textAlign: 'center' as const },
  lineItemCard: { backgroundColor: Colors.card, borderRadius: Tokens.radius.card, padding: 14, marginBottom: Tokens.spacing.xs, borderWidth: 1, borderColor: Colors.cardBorder },
  ...
  newBadge: { backgroundColor: Colors.accent + '20', paddingHorizontal: 6, paddingVertical: Tokens.spacing.hairline, borderRadius: 4 },
  newBadgeText: { fontSize: 9, fontWeight: '700' as const, color: Colors.accent },
  lineItemName: { fontSize: Type.subhead.fontSize, fontWeight: '600' as const, color: Colors.text, flex: 1 },
  lineItemFields: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xs },
  lineItemFieldSmall: { flex: 1, gap: Tokens.spacing.hairline },
  lineItemFieldLabel: { fontSize: 10, fontWeight: '600' as const, color: Colors.textMuted, textTransform: 'uppercase' as const },
  lineItemInput: { minHeight: 36, borderRadius: Tokens.radius.sm, backgroundColor: Colors.surfaceAlt, paddingHorizontal: Tokens.spacing.xs, fontSize: Type.bodyCompact.fontSize, color: Colors.text },
  lineItemUnitText: { fontSize: Type.bodyCompact.fontSize, color: Colors.textSecondary, paddingVertical: Tokens.spacing.xs },
  lineItemTotal: { fontSize: Type.subhead.fontSize, fontWeight: '700' as const, color: Colors.primary },
  lockedCard: { backgroundColor: Colors.card, borderRadius: Tokens.radius.card, padding: Tokens.spacing.md, borderWidth: 1, borderColor: Colors.cardBorder, gap: Tokens.spacing.xxs },
  lockedTitle: { fontSize: Type.subhead.fontSize, fontWeight: '600' as const, color: Colors.text },
  lockedSub: { fontSize: Type.footnote.fontSize, color: Colors.textSecondary },
  lockedFieldText: { flex: 1, fontSize: Type.bodyCompact.fontSize, color: Colors.textSecondary },
  ...
  ccdRow: {
    ...
    paddingHorizontal: Tokens.spacing.lg, paddingVertical: Tokens.spacing.xs,
  ...
  estimateItemRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 14, borderBottomWidth: 1, borderBottomColor: Colors.borderLight, gap: Tokens.spacing.sm },
  estimateItemName: { fontSize: Type.subhead.fontSize, fontWeight: '600' as const, color: Colors.text },
  estimateItemMeta: { fontSize: Type.caption1.fontSize, color: Colors.textMuted, marginTop: Tokens.spacing.hairline },
  addSearchBtn: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xxs, paddingHorizontal: 10, paddingVertical: 6, borderRadius: Tokens.radius.sm, backgroundColor: Colors.successLight },
  addSearchBtnText: { fontSize: Type.caption1.fontSize, fontWeight: '600' as const, color: Colors.success },
  matSearchBar: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.surfaceAlt, borderRadius: Tokens.radius.card, paddingHorizontal: Tokens.spacing.sm, gap: Tokens.spacing.xs, height: 44, borderWidth: 1, borderColor: Colors.cardBorder },
  matSearchInput: { flex: 1, fontSize: Type.subhead.fontSize, color: Colors.text },
  priceTypeRow: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xs, marginTop: Tokens.spacing.xs },
  priceTypeChip: { paddingHorizontal: Tokens.spacing.sm, paddingVertical: 6, borderRadius: Tokens.radius.sm, backgroundColor: Colors.fillTertiary },
  priceTypeChipActive: { backgroundColor: Colors.primary },
  priceTypeText: { fontSize: Type.caption1.fontSize, fontWeight: '600' as const, color: Colors.textSecondary },
  priceTypeTextActive: { color: Colors.textOnPrimary },
  matMarkupRow: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xxs, marginLeft: 'auto' as const, backgroundColor: Colors.fillTertiary, borderRadius: Tokens.radius.sm, paddingHorizontal: Tokens.spacing.xs, paddingVertical: Tokens.spacing.xxs },
  matMarkupInput: { width: 36, fontSize: Type.bodyCompact.fontSize, fontWeight: '600' as const, color: Colors.text, textAlign: 'center' as const },
  matMarkupLabel: { fontSize: Type.caption2.fontSize, color: Colors.textMuted },
  matResultCount: { fontSize: Type.caption2.fontSize, color: Colors.textMuted, marginTop: 6, marginBottom: Tokens.spacing.xxs },
  matResultRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: Tokens.spacing.sm, borderBottomWidth: 1, borderBottomColor: Colors.borderLight, gap: 10 },
  matResultName: { fontSize: Type.bodyCompact.fontSize, fontWeight: '600' as const, color: Colors.text },
  matResultMeta: { flexDirection: 'row', gap: Tokens.spacing.xs, marginTop: Tokens.spacing.hairline },
  matResultCat: { fontSize: Type.caption2.fontSize, color: Colors.info, fontWeight: '500' as const },
  matResultSupplier: { fontSize: Type.caption2.fontSize, color: Colors.textMuted },
  matOriginalPrice: { fontSize: 10, color: Colors.warning, fontWeight: '500' as const, marginTop: Tokens.spacing.hairline },
  matResultPrices: { alignItems: 'flex-end', gap: 1 },
  matResultRetail: { fontSize: Type.caption2.fontSize, color: Colors.textMuted, textDecorationLine: 'line-through' as const },
  matResultBulk: { fontSize: Type.bodyCompact.fontSize, fontWeight: '700' as const, color: Colors.success },
