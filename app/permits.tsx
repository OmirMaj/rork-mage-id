  ...
  return (
    <View style={styles.container}>
      <Stack.Screen options={{
        ...
        headerRight: () => (
          <TouchableOpacity onPress={openNewForm} style={{ paddingHorizontal: Tokens.spacing.sm, paddingVertical: 6 }} testID="new-permit-btn" accessibilityRole="button" accessibilityLabel="Add"><Plus size={22} color={Colors.primary} /></TouchableOpacity>
        ),
      }} />
...
const styles = StyleSheet.create({
  ...
  filterRow: { paddingHorizontal: Tokens.spacing.md, gap: Tokens.spacing.xs, paddingBottom: Tokens.spacing.md },
  filterChip: {
    paddingHorizontal: Tokens.spacing.md,
    paddingVertical: Tokens.spacing.xs,
    borderRadius: 20,
  ...
  permitCardInner: { padding: 14, gap: Tokens.spacing.xxs },
  permitHeader: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xs, marginBottom: Tokens.spacing.xxs },
  ...
  statusBadge: { paddingHorizontal: 10, paddingVertical: Tokens.spacing.xxs, borderRadius: Tokens.radius.sm },
  ...
  attachRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: Tokens.spacing.xxs },
  ...
  emptyState: { alignItems: 'center', paddingVertical: Tokens.spacing['4xl'], gap: Tokens.spacing.xs },
  emptyTitle: { fontSize: Type.body.fontSize, fontWeight: '600' as const, color: Colors.text },
  emptySub: { fontSize: Type.footnote.fontSize, color: Colors.textSecondary, textAlign: 'center', paddingHorizontal: Tokens.spacing['3xl'], lineHeight: 18 },
  emptyCta: {
  ...
  modalCard: {
    ...
    paddingHorizontal: Tokens.spacing.md, paddingBottom: Tokens.spacing.xl,
  },
  modalHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: Tokens.spacing.sm },
  modalTitle: { fontSize: Type.subheadline.fontSize, fontWeight: '700' as const, color: Colors.text },
  formLabel: { fontSize: Type.caption1.fontSize, fontWeight: '700' as const, color: Colors.textSecondary, marginTop: Tokens.spacing.sm, marginBottom: 6, textTransform: 'uppercase' as const, letterSpacing: 0.5 },
  formInput: {
    backgroundColor: Colors.surface,
  ...
  pickerRow: { paddingHorizontal: Tokens.spacing.sm, paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: Colors.cardBorder + '60' },
  ...
  attachHint: { fontSize: Type.caption2.fontSize, color: Colors.textMuted, marginTop: Tokens.spacing.xxs, paddingHorizontal: Tokens.spacing.xxs },
