...
const styles = StyleSheet.create({
  ...
  typeBadge: { backgroundColor: Colors.primary + '15', paddingHorizontal: 10, paddingVertical: 4, borderRadius: Tokens.radius.xs },
  ...
  title: { fontSize: Type.title2.fontSize, fontWeight: '800' as const, color: Colors.text, marginBottom: 4 },
  company: { fontSize: Type.subhead.fontSize, color: Colors.textSecondary, marginBottom: 8 },
  ...
  applicantInfo: { fontSize: Type.footnote.fontSize, color: Colors.textSecondary, textAlign: 'center' as const, marginBottom: 4 },
  applyBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: Colors.primary, paddingVertical: 16, borderRadius: Tokens.radius.card, gap: 8 },
  appliedBtn: { backgroundColor: Colors.textMuted },
  applyBtnText: { color: '#FFF', fontSize: Type.callout.fontSize, fontWeight: '700' as const },
  messageBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: Colors.primary + '12', paddingVertical: 14, borderRadius: Tokens.radius.card, gap: 8 },
