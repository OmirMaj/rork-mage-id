...
const styles = StyleSheet.create({
  ...
  heroSubRow: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: Tokens.spacing.xs, marginTop: Tokens.spacing.xxs },
  heroStatusPill: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: Tokens.spacing.xxs, paddingHorizontal: 10, paddingVertical: Tokens.spacing.xxs, borderRadius: Tokens.radius.card },
  heroStatusText: { fontSize: Type.caption2.fontSize, fontWeight: '700' as const, letterSpacing: 0.3 },
  heroDelta: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: Tokens.spacing.xxs, paddingHorizontal: 10, paddingVertical: Tokens.spacing.xxs, borderRadius: Tokens.radius.card, backgroundColor: 'rgba(255,255,255,0.15)' },
  ...
  forecastChip: { paddingHorizontal: Tokens.spacing.sm, paddingVertical: 6, borderRadius: Tokens.radius.sm, backgroundColor: 'rgba(255,255,255,0.15)' },
  ...
  customWeeksChip: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: Tokens.spacing.xxs, paddingHorizontal: 10, paddingVertical: Tokens.spacing.xxs, borderRadius: Tokens.radius.sm, backgroundColor: 'rgba(255,255,255,0.15)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.25)' },
  customWeeksInput: { minWidth: 34, paddingVertical: 0, paddingHorizontal: Tokens.spacing.hairline, fontSize: Type.caption1.fontSize, fontWeight: '700' as const, color: Colors.surface, textAlign: 'center' as const },
  ...
  pendingItem: { flex: 1, gap: Tokens.spacing.hairline },
  ...
  section: { marginHorizontal: Tokens.spacing.md, marginTop: Tokens.spacing.lg },
  ...
  sectionHeaderRow: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xs, backgroundColor: Colors.surface, borderRadius: Tokens.radius.lg, padding: 14, borderWidth: 1, borderColor: Colors.cardBorder },
  sectionTitle: { flex: 1, fontSize: Type.subhead.fontSize, fontWeight: '600' as const, color: Colors.text },
  sectionAmount: { fontSize: Type.bodyCompact.fontSize, fontWeight: '700' as const, color: Colors.error, marginRight: Tokens.spacing.xxs },
  expandedContent: { backgroundColor: Colors.surface, borderRadius: Tokens.radius.lg, padding: 14, marginTop: 6, borderWidth: 1, borderColor: Colors.cardBorder, gap: Tokens.spacing.xs },
  expenseListRow: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: Tokens.spacing.xs, borderBottomWidth: 1, borderBottomColor: Colors.borderLight },
  expenseListInfo: { flex: 1, gap: Tokens.spacing.hairline },
  ...
  incomeListRow: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: Tokens.spacing.xs, borderBottomWidth: 1, borderBottomColor: Colors.borderLight },
  incomeListInfo: { flex: 1, gap: Tokens.spacing.hairline },
  ...
  confidenceBadge: { paddingHorizontal: 6, paddingVertical: Tokens.spacing.hairline, borderRadius: 4 },
  confidenceBadgeText: { fontSize: 10, fontWeight: '700' as const },
  emptyListText: { fontSize: Type.footnote.fontSize, color: Colors.textMuted, textAlign: 'center', paddingVertical: Tokens.spacing.sm },
  addItemBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, paddingVertical: 10, marginTop: Tokens.spacing.xxs },
  addItemText: { fontSize: Type.bodyCompact.fontSize, fontWeight: '600' as const, color: Colors.primary },
  dangerCard: { backgroundColor: Colors.errorLight, borderRadius: Tokens.radius.panel, padding: Tokens.spacing.md, borderWidth: 1, borderColor: Colors.error + '40', gap: 10, shadowColor: Colors.error, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.12, shadowRadius: 12, elevation: 2 },
  dangerHeader: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xs },
  dangerTitle: { fontSize: Type.subhead.fontSize, fontWeight: '800' as const, color: Colors.error, letterSpacing: 0.2 },
  dangerRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingLeft: 26, paddingVertical: Tokens.spacing.xxs, borderTopWidth: 1, borderTopColor: Colors.error + '15' },
  ...
  weekDetailRow: { flexDirection: 'row', gap: Tokens.spacing.xs },
  weekDetailItem: { flex: 1, alignItems: 'center', backgroundColor: Colors.surfaceAlt, borderRadius: Tokens.radius.md, padding: 10, gap: Tokens.spacing.xxs },
  ...
  weekItemsGroup: { marginTop: Tokens.spacing.sm, gap: Tokens.spacing.xxs },
  weekItemsLabel: { fontSize: Type.caption1.fontSize, fontWeight: '600' as const, color: Colors.textMuted, marginBottom: Tokens.spacing.xxs, textTransform: 'uppercase' as const, letterSpacing: 0.5 },
  weekItemRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: Tokens.spacing.xxs },
  weekItemName: { flex: 1, fontSize: Type.footnote.fontSize, color: Colors.text, marginRight: Tokens.spacing.xs },
  weekItemAmount: { fontSize: Type.footnote.fontSize, fontWeight: '700' as const },
  emptyWeekText: { fontSize: Type.footnote.fontSize, color: Colors.textMuted, textAlign: 'center', paddingVertical: Tokens.spacing.md },
  aiButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: Tokens.spacing.xs, backgroundColor: Colors.primary, borderRadius: Tokens.radius.lg, paddingVertical: 14, shadowColor: Colors.primary, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 12, elevation: 3 },
  aiButtonText: { fontSize: Type.callout.fontSize, fontWeight: '700' as const, color: Colors.textOnPrimary },
  aiResultsCard: { backgroundColor: Colors.surface, borderRadius: Tokens.radius.panel, padding: Tokens.spacing.md, marginTop: Tokens.spacing.sm, borderWidth: 1, borderColor: Colors.cardBorder, gap: Tokens.spacing.sm },
  aiResultsHeader: { flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing.xs },
  aiResultsTitle: { flex: 1, fontSize: Type.callout.fontSize, fontWeight: '700' as const, color: Colors.text },
  healthBadge: { paddingHorizontal: 10, paddingVertical: Tokens.spacing.xxs, borderRadius: Tokens.radius.sm },
  ...
  aiSection: { gap: Tokens.spacing.xs, marginTop: Tokens.spacing.xxs },
  ...
  criticalWeekRow: { flexDirection: 'row', alignItems: 'flex-start', gap: Tokens.spacing.xs, paddingVertical: Tokens.spacing.xxs },
  criticalWeekText: { flex: 1, fontSize: Type.footnote.fontSize, color: Colors.textSecondary, lineHeight: 18 },
  recCard: { borderRadius: Tokens.radius.card, padding: Tokens.spacing.sm, borderWidth: 1, gap: 6 },
  recHeader: { flexDirection: 'row', gap: 6 },
  recPriorityBadge: { paddingHorizontal: Tokens.spacing.xs, paddingVertical: Tokens.spacing.hairline, borderRadius: 4 },
  recPriorityText: { fontSize: 10, fontWeight: '700' as const, textTransform: 'uppercase' as const },
  recDiffBadge: { paddingHorizontal: Tokens.spacing.xs, paddingVertical: Tokens.spacing.hairline, borderRadius: 4 },
  ...
  bulletRow: { flexDirection: 'row', alignItems: 'flex-start', gap: Tokens.spacing.xs },
  bulletText: { flex: 1, fontSize: Type.footnote.fontSize, color: Colors.textSecondary, lineHeight: 18 },
  aiGenLabel: { fontSize: Type.caption2.fontSize, color: Colors.textMuted, textAlign: 'right', marginTop: Tokens.spacing.xxs },
  modalOverlay: { flex: 1, backgroundColor: Colors.overlay, justifyContent: 'center', padding: Tokens.spacing.xl },
  modalCard: { backgroundColor: Colors.surface, borderRadius: 20, padding: Tokens.spacing.lg, gap: Tokens.spacing.sm },
  modalCardBottom: { position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: Colors.surface, borderTopLeftRadius: 28, borderTopRightRadius: 28, padding: Tokens.spacing.lg, maxHeight: '80%', gap: 10 },
  modalHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  modalTitle: { fontSize: Type.subheadline.fontSize, fontWeight: '700' as const, color: Colors.text },
  modalFieldLabel: { fontSize: Type.caption1.fontSize, fontWeight: '600' as const, color: Colors.textSecondary, marginTop: Tokens.spacing.xs },
  modalInputRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.surfaceAlt, borderRadius: Tokens.radius.card, paddingHorizontal: Tokens.spacing.sm },
  modalDollar: { fontSize: Type.title3.fontSize, fontWeight: '800' as const, color: Colors.primary },
  modalInput: { flex: 1, minHeight: 48, fontSize: Type.title3.fontSize, fontWeight: '700' as const, color: Colors.text, paddingHorizontal: Tokens.spacing.xs },
  ...
  chip: { paddingHorizontal: Tokens.spacing.sm, paddingVertical: Tokens.spacing.xs, borderRadius: Tokens.radius.md, backgroundColor: Colors.fillTertiary },
  chipActive: { backgroundColor: Colors.primary },
  chipText: { fontSize: Type.footnote.fontSize, fontWeight: '600' as const, color: Colors.textSecondary },
  chipTextActive: { color: Colors.textOnPrimary },
  modalSaveBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: Colors.primary, borderRadius: Tokens.radius.lg, paddingVertical: 14, marginTop: Tokens.spacing.sm },
