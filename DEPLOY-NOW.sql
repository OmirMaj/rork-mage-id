-- ============================================================
-- MAGE ID — paste-ready deploy, regenerated 2026-08-27
-- 10 migrations, in order. All idempotent.
...
--
-- FIXED SINCE THE LAST BUNDLE: #9 declared a column named `window`, which is a
-- RESERVED Postgres keyword. It would have raised a syntax error partway
-- through this file, AFTER #1-#8 had already committed. Renamed to
-- delivery_window; scripts/validate-sql-identifiers.ts now blocks the class.
-- ============================================================
