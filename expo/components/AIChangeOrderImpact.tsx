      ...
      {isExpanded && (
        <>
          <View style={styles.section}>
            ...
            {(Array.isArray(result.affectedTasks) ? result.affectedTasks : []).map((task, idx) => (
          ...
          {(Array.isArray(result.downstreamEffects) ? result.downstreamEffects : []).length > 0 && (
            <View style={styles.section}>
              <View style={styles.sectionHeader}>
                <Zap size={14} color={Colors.warning} />
                <Text style={styles.sectionTitle}>Downstream Effects</Text>
              </View>
              {(Array.isArray(result.downstreamEffects) ? result.downstreamEffects : []).map((effect, idx) => (
          ...
          {(Array.isArray(result.compressionOptions) ? result.compressionOptions : []).length > 0 && (
            <View style={styles.section}>
              <Text style={styles.recTitle}>Compression Options</Text>
              {(Array.isArray(result.compressionOptions) ? result.compressionOptions : []).map((opt, idx) => (
