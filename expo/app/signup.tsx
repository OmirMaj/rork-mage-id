...
import { HardHat, Mail, Lock, Eye, EyeOff, User, ArrowRight, ChevronLeft, Phone } from 'lucide-react-native';
        ...
        >
          ...
          {showPhoneAuth ? (
            ...
            >
              ...
              <Text style={styles.phoneAuthText}>Sign up with Phone Number</Text>
            </TouchableOpacity>
          )}
