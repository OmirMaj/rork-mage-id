  ...
  return (
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      ...
      >
        ...
        <Text style={styles.sectionHeader}>PROFILE & TEMPLATES</Text>
        <View style={styles.group}>
          <TouchableOpacity
            style={styles.row}
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={{ fontSize: 12, color: Colors.textSecondary }}>Professional contractor resume</Text>
            </View>
            <ChevronRight size={16} color={Colors.textMuted} />
          </TouchableOpacity>
          <View style={styles.rowSeparator} />
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              <Text style={styles.rowLabel}>My Templates</Text>
              <Text style={{ fontSize: 12, color: Colors.textSecondary }}>Custom PDF & HTML templates</Text>
            </View>
            <ChevronRight size={16} color={Colors.textMuted} />
          </TouchableOpacity>
        </View>
          ...
          {supplierProfile ? (
            <View style={styles.supplierRegistered}>
              <View style={styles.supplierCardTop}>
                <View style={styles.supplierAvatarLarge}>
                  <Text style={styles.supplierAvatarText}>{supplierProfile.companyName.charAt(0).toUpperCase()}</Text>
                </View>
                <View style={{ flex: 1, gap: 3 }}>
                  <Text style={styles.supplierCompanyName}>{supplierProfile.companyName}</Text>
                  {supplierProfile.contactName ? <Text style={styles.supplierContactName}>{supplierProfile.contactName}</Text> : null}
                  <View style={styles.supplierRatingRow}>
                    {[1,2,3,4,5].map(s => (
                      <Star key={s} size={12} color={s <= Math.round(supplierProfile.rating) ? '#FF9500' : Colors.borderLight} fill={s <= Math.round(supplierProfile.rating) ? '#FF9500' : 'transparent'} />
                    ))}
                    <Text style={styles.supplierRatingText}>{supplierProfile.rating.toFixed(1)}</Text>
                  </View>
                </View>
              </View>
              {supplierProfile.address ? (
                <View style={styles.supplierDetailRow}>
                  ...
                  <Text style={styles.supplierDetailText} numberOfLines={1}>{supplierProfile.address}</Text>
                </View>
              ) : null}
              {supplierProfile.phone ? (
                <View style={styles.supplierDetailRow}>
                  <Phone size={12} color={Colors.textSecondary} />
                  <Text style={styles.supplierDetailText}>{supplierProfile.phone}</Text>
                </View>
              ) : null}
              {supplierProfile.email ? (
                <View style={styles.supplierDetailRow}>
                  <Mail size={12} color={Colors.textSecondary} />
                  <Text style={styles.supplierDetailText}>{supplierProfile.email}</Text>
                </View>
              ) : null}
              {supplierProfile.minOrderAmount > 0 ? (
                <View style={styles.supplierDetailRow}>
                  <DollarSign size={12} color={Colors.textSecondary} />
                  <Text style={styles.supplierDetailText}>Min order: ${supplierProfile.minOrderAmount.toLocaleString()}</Text>
                </View>
              ) : null}
              <View style={styles.supplierChipsWrap}>
                {supplierProfile.categories.map(cat => (
                  <View key={cat} style={styles.supplierCatPill}>
                    <Text style={styles.supplierCatPillText}>{cat.charAt(0).toUpperCase() + cat.slice(1)}</Text>
                  </View>
                ))}
              </View>
              <View style={styles.supplierChipsWrap}>
                {supplierProfile.deliveryOptions.map(opt => (
                  <View key={opt} style={styles.supplierDeliveryBadge}>
                    <Truck size={10} color={Colors.primary} />
                    <Text style={styles.supplierDeliveryBadgeText}>{opt}</Text>
                  </View>
                ))}
              </View>
              <TouchableOpacity
                style={styles.supplierEditBtnLarge}
                onPress={() => setShowSupplierForm(true)}
                activeOpacity={0.7}
              >
                <PenTool size={14} color="#fff" />
                <Text style={styles.supplierEditBtnLargeText}>Edit Profile</Text>
              </TouchableOpacity>
            </View>
          ) : (
            <TouchableOpacity
        ...
        <View style={styles.group}>
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              <Text style={styles.rowLabel}>App Tutorial</Text>
              <Text style={{ fontSize: 12, color: Colors.textSecondary }}>Learn how MAGE ID works</Text>
            </View>
            <ChevronRight size={16} color={Colors.textMuted} />
          </TouchableOpacity>
          <View style={styles.rowSeparator} />
          <TouchableOpacity
            style={styles.row}
            onPress={() => Linking.openURL('mailto:support@mageid.app')}
            activeOpacity={0.7}
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              const url = Platform.OS === 'ios'
                ...
                : 'https://play.google.com/store/apps/details?id=com.mageid.app';
          ...
          >
            ...
            <Text style={styles.rowLabel}>Rate MAGE ID</Text>
            <ChevronRight size={16} color={Colors.textMuted} />
          </TouchableOpacity>
        </View>
          ...
          <View style={styles.sigModalOverlay}>
            ...
            >
              <View style={[styles.sigModalCard, { maxWidth: 500, width: '100%', alignSelf: 'center' as const, paddingBottom: insets.bottom + 20 }]}>
                <View style={styles.sigModalHeader}>
                  <Text style={styles.sigModalTitle}>{supplierProfile ? supCompanyName || 'Edit Profile' : 'Register as Supplier'}</Text>
                  <TouchableOpacity onPress={() => setShowSupplierForm(false)}>
                    <X size={20} color={Colors.textMuted} />
                  </TouchableOpacity>
                </View>

                <View style={styles.supFormAvatarWrap}>
                  <View style={styles.supFormAvatar}>
                    <Text style={styles.supFormAvatarText}>{supCompanyName ? supCompanyName.charAt(0).toUpperCase() : '?'}</Text>
                  </View>
                  <TouchableOpacity style={styles.supFormCameraBtn} activeOpacity={0.7}>
                    <Camera size={14} color={Colors.primary} />
                  </TouchableOpacity>
                </View>

                <View style={styles.supFormDivider}>
                  <Text style={styles.supFormSectionTitle}>BUSINESS INFO</Text>
                </View>
                ...
                <View style={styles.supFormDivider}>
                  <Text style={styles.supFormSectionTitle}>LOCATION & WEB</Text>
                </View>
                ...
                <View style={styles.supFormDivider}>
                  <Text style={styles.supFormSectionTitle}>ABOUT</Text>
                </View>
                <Text style={styles.supFieldLabel}>Description</Text>
                <TextInput
                  style={[styles.supplierInput, { minHeight: 100, paddingTop: 12, textAlignVertical: 'top' as const }]}
                ...
                <View style={styles.supFormDivider}>
                  <Text style={styles.supFormSectionTitle}>CATEGORIES</Text>
                </View>
                ...
                <View style={styles.supFormDivider}>
                  <Text style={styles.supFormSectionTitle}>DELIVERY & ORDERS</Text>
                </View>
                <Text style={styles.supFieldLabel}>Delivery Options (comma separated)</Text>
                <TextInput
                  style={styles.supplierInput}
                  value={supDelivery}
                  ...
                  placeholderTextColor={Colors.textMuted}
                />
                <Text style={styles.supFieldLabel}>Min Order Amount ($)</Text>
                <TextInput
                  style={styles.supplierInput}
                  value={supMinOrder}
...
const styles = StyleSheet.create({
  ...
  supplierDeliveryBadgeText: {
    fontSize: 11,
    fontWeight: '500' as const,
    color: Colors.textSecondary,
  },
  supplierEditBtnLarge: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'center',
    gap: 8,
