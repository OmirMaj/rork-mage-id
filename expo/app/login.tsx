...
import { HardHat, Mail, Lock, Eye, EyeOff, ArrowRight, ScanFace, UserX, KeyRound, Chrome, Phone } from 'lucide-react-native';
...
let _LocalAuthentication: any = null;
...
export default function LoginScreen() {
  ...
  useEffect(() => {
    ...
    const checkBiometrics = async () => {
      try {
        const mod = require('expo-local-authentication') as any;
        ...
        >
          ...
          {showPhoneAuth ? (
            <PhoneAuth
              mode="login"
              onSuccess={() => {
                track(AnalyticsEvents.USER_LOGGED_IN, { method: 'phone' });
                router.replace('/(tabs)/(home)');
              }}
            ...
            >
              ...
              <Text style={styles.phoneAuthText}>Log in with Phone Number</Text>
            </TouchableOpacity>
          )}
