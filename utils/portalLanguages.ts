...
export interface PortalUIStrings {
  ...
  // Same words as the page's CONTRACT_COPY (marketing/portal/index.html):
  // the terms are read ON the portal, and the signed copy is the GC's to send
  // — never "in the app" or "emailed to you" (#64, integration round 1).
...
const en: PortalUIStrings = {
  ...
  contractSignerExplainer: 'Your contractor has signed and sent this agreement. Read the scope, payment schedule, warranty and terms below, then enter your full legal name to counter-sign and make it binding.',
  contractSignNamePlaceholder: 'Type your full legal name',
  contractSignButton: 'Sign & make binding',
  contractFinePrint: 'By typing your name and tapping Sign, you accept the agreement as legally binding. Your contractor keeps the sealed signed copy and can send it to you.',
...
const es: PortalUIStrings = {
  ...
  contractSignerExplainer: 'Su contratista ha firmado y enviado este acuerdo. Lea abajo el alcance, el cronograma de pagos, la garantía y los términos; luego escriba su nombre legal completo para firmar y hacerlo vinculante.',
  contractSignNamePlaceholder: 'Escriba su nombre legal completo',
  contractSignButton: 'Firmar y hacer vinculante',
  contractFinePrint: 'Al escribir su nombre y pulsar Firmar, acepta el acuerdo como legalmente vinculante. Su contratista conserva la copia firmada y sellada y puede enviársela.',
...
const pt: PortalUIStrings = {
  ...
  contractSignerExplainer: 'Seu construtor assinou e enviou este acordo. Leia abaixo o escopo, o cronograma de pagamentos, a garantia e os termos; depois digite seu nome legal completo para contra-assinar e torná-lo vinculante.',
  contractSignNamePlaceholder: 'Digite seu nome legal completo',
  contractSignButton: 'Assinar e tornar vinculante',
  contractFinePrint: 'Ao digitar seu nome e tocar em Assinar, você aceita o acordo como legalmente vinculante. Seu construtor guarda a cópia assinada e selada e pode enviá-la a você.',
...
const zh: PortalUIStrings = {
  ...
  contractSignerExplainer: '您的承包商已签署并发送此协议。请阅读下方的工程范围、付款计划、保修和条款,然后输入您的法定全名进行会签,使其生效。',
  contractSignNamePlaceholder: '输入您的法定全名',
  contractSignButton: '签字使其生效',
  contractFinePrint: '输入姓名并点击"签字"即表示您接受此协议具有法律约束力。您的承包商会保留已签署并加封的副本,并可发送给您。',
...
const vi: PortalUIStrings = {
  ...
  contractSignerExplainer: 'Nhà thầu đã ký và gửi thỏa thuận này. Hãy đọc phạm vi công việc, lịch thanh toán, bảo hành và các điều khoản bên dưới, sau đó nhập tên đầy đủ hợp pháp của bạn để đối ký và làm hợp đồng có hiệu lực.',
  contractSignNamePlaceholder: 'Nhập tên đầy đủ hợp pháp',
  contractSignButton: 'Ký và xác nhận',
  contractFinePrint: 'Bằng cách nhập tên và bấm Ký, bạn chấp nhận thỏa thuận có giá trị pháp lý. Nhà thầu giữ bản đã ký có niêm phong và có thể gửi cho bạn.',
...
const fr: PortalUIStrings = {
  ...
  contractSignerExplainer: 'Votre entrepreneur a signé et envoyé cet accord. Lisez ci-dessous l\'étendue des travaux, le calendrier de paiement, la garantie et les conditions, puis saisissez votre nom légal complet pour contresigner et le rendre exécutoire.',
  contractSignNamePlaceholder: 'Saisissez votre nom légal complet',
  contractSignButton: 'Signer et rendre exécutoire',
  contractFinePrint: 'En saisissant votre nom et en touchant Signer, vous acceptez l\'accord comme juridiquement contraignant. Votre entrepreneur conserve la copie signée et scellée et peut vous l\'envoyer.',
